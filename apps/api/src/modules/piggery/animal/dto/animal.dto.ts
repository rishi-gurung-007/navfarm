...
export class CreateAnimalDto {
  @ApiProperty({
    description:
      'Optional manual code; omit to allocate from the configured animal series',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description:
      "Line of Business UUID scope. Omit to derive it from the company's operational areas.",
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Date of birth — omit if born on this farm and unknown or if imported/unknown',
    required: false,
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'How this animal entered the register',
    enum: ENTRY_TYPES,
  })
  @IsString()
  @IsIn(ENTRY_TYPES)
  ...
  @ApiProperty({
    description:
      'Goods Receipt UUID this animal arrived on — required if entry_type is PURCHASED_IMPORTED/PURCHASED_LOCAL',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Batch UUID that produced this animal — required if entry_type is BORN_ON_FARM',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Item UUID (LIVING_ASSET catalogue entry) for this animal type',
  })
  @IsUUID()
  @IsNotEmpty()
  item_id: string;
  ...
  @ApiProperty({
    description: 'RFID ear tag number for scanning — unique if set',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'URL to a photo of the ear tag — file upload will move to Cloudflare R2 later',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Father boar UUID — self-referential',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Mother sow UUID — self-referential',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Transport/import duty/quarantine charges per head for imported animals',
    required: false,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Current production stage UUID',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Batch UUID this animal is currently in',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Current shed/pen location UUID',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Date animal entered productive stage — first farrowing or PRODUCTIVE_SOW status',
    required: false,
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Teat count — BBP: below 15 is a hard block on gilt selection regardless of TSI score',
    required: false,
  })
  @IsInt()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Serial number (asset tag), distinct from RFID/ear tag',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class UpdateAnimalDto {
  ...
  @ApiProperty({
    description:
      'Not ledger-derived yet — settable directly until per-animal bio-asset ledger integration exists',
    required: false,
  })
  @IsNumber()
  @IsOptional()
...
export class DisposeAnimalDto {
  @ApiProperty({
    description: 'How this animal left the register',
    enum: DISPOSAL_TYPES,
  })
  @IsString()
  @IsIn(DISPOSAL_TYPES)
  ...
  @ApiProperty({
    description: 'Sale/salvage value realised, if any',
    required: false,
  })
  @IsNumber()
  @IsOptional()
...
export class QueryAnimalDto extends MasterListQueryDto {
  ...
  @ApiProperty({
    description: 'Search animal_code, rfid_tag, or ear_tag',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Include disposed (is_active=false) animals',
    required: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Filter by active status (findAll already excludes disposed animals unless includeDisposed is set; declared so pickers can send the same isActive param every other list endpoint accepts without a 400)',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
...
export class TransitionAnimalStageDto {
  ...
  @ApiProperty({
    description: 'Destination Location / Pen UUID (optional)',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Destination Batch UUID (optional)',
    required: false,
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Reason for transition / Trigger condition (e.g. PREGNANCY_CONFIRMED, WEANED, MANUAL)',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class BulkTransitionAnimalStageDto extends TransitionAnimalStageDto {
  @ApiProperty({
    description:
      'Animals to move together — typically the tail-enders that a batch-level stage move deliberately left behind',
    type: [String],
  })
  @IsArray()
  @ArrayNotEmpty()
