...
export class CreateFormulaIngredientDto {
  @ApiProperty({
    description: 'Raw material Item UUID',
    example: 'maize-item-uuid',
  })
  @IsUUID()
  @IsNotEmpty()
  item_id: string;
  ...
  @ApiProperty({
    description: 'Ingredient quantity in the batch',
    example: 650.0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Percentage of inclusion in total formula',
    required: false,
    example: 65.0,
  })
  @IsNumber()
  ...
  @ApiProperty({
    description: 'Process loss percentage',
    required: false,
    example: 0.5,
  })
  @IsNumber()
...
export class CreateFeedFormulaDto {
  ...
  @ApiProperty({
    description:
      'Unique code representing the formula recipe/BOM. Optional when a number series is configured for feed formulas — the code is generated then.',
    required: false,
    example: 'FORM-BR-STARTER',
  })
  @IsString()
  @IsOptional()
  formula_code?: string;
  ...
  @ApiProperty({
    description: 'Common name of the formula',
    example: 'Broiler Starter Feed Formula',
  })
  @IsString()
  @IsNotEmpty()
  formula_name: string;
  ...
  @ApiProperty({
    description: 'Produced Item UUID link',
    example: 'produced-feed-item-uuid',
  })
  @IsUUID()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Total recipe batch production size',
    example: 1000.0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Description or notes for the feed recipe',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'List of ingredients in this formula',
  })
  @IsArray()
...
export class QueryFeedFormulaDto extends MasterListQueryDto {
  ...
  @ApiProperty({
    description: 'Filter by produced target item UUID',
    required: false,
  })
  @IsOptional()
  @IsUUID()
