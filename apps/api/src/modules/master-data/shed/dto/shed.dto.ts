...
export class CreateShedDto {
  ...
  @ApiProperty({
    description: 'Farm UUID mapping (belongs to this Farm)',
  ...
  @ApiProperty({
    description: 'Unique code representing the shed within the farm',
    example: 'SHED01',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Full name of the shed',
    example: 'Broiler Grow-out Shed 1',
  })
  @IsString()
  @IsNotEmpty()
  shed_name: string;
  ...
  @ApiProperty({
    description: 'Shed type classification',
    example: 'ENVIRONMENTALLY_CONTROLLED',
    enum: ['OPEN_SIDED', 'ENVIRONMENTALLY_CONTROLLED', 'SEMI_EC'],
  })
  @IsString()
  @IsNotEmpty()
  shed_type: string;
  ...
  @ApiProperty({
    description: 'Maximum holding capacity (birds/animals)',
    default: 0,
    required: false,
  })
  @IsInt()
