...
export const DOCUMENTED_REASONS: DocumentedReason[] = [
  ...
  { reason_code: 'MRT-002', reason_name: 'Enteric Disease (PED/Rotavirus/Scours)', category: 'MORTALITY', sub_category: 'Disease', applicable_stages: ['WEANER', 'LACTATION'], stage_filter_note: 'WEANER / LACTATION', mandatory_comment: false, mandatory_weight: false },
  ...
  { reason_code: 'MRT-005', reason_name: 'Greasy Pig Disease (Exudative Dermatitis)', category: 'MORTALITY', sub_category: 'Disease', applicable_stages: ['WEANER'], stage_filter_note: 'WEANER', mandatory_comment: false, mandatory_weight: false },
  { reason_code: 'MRT-006', reason_name: 'Meningitis / Streptococcus', category: 'MORTALITY', sub_category: 'Disease', applicable_stages: ['WEANER', 'GROWER'], stage_filter_note: 'WEANER / GROWER', mandatory_comment: false, mandatory_weight: false },
  ...
  { reason_code: 'MRT-008', reason_name: 'Fighting / Biting Injury', category: 'MORTALITY', sub_category: 'Trauma', applicable_stages: ['WEANER', 'GROWER', 'GILT_GROWER'], stage_filter_note: 'WEANER / GROWER / GILT_REARING', mandatory_comment: false, mandatory_weight: false },
  ...
  { reason_code: 'MRT-018', reason_name: 'Ration Pig (Farm Butchery / Home Consumption)', category: 'MORTALITY', sub_category: 'Ration Pig', applicable_stages: ['WEANER', 'GROWER'], stage_filter_note: 'WEANER / GROWER', mandatory_comment: false, mandatory_weight: false },
  ...
  { reason_code: 'DIS-002', reason_name: 'Colcom Abattoir (Commercial Slaughter)', category: 'DISPOSAL', sub_category: 'Destination', applicable_stages: ['GROWER'], stage_filter_note: 'GROWER / SOW', mandatory_comment: false, mandatory_weight: false },
  ...
  { reason_code: 'TRF-003', reason_name: 'External Transfer - To Colcom Slaughter', category: 'TRANSFER', sub_category: 'External', applicable_stages: ['GROWER'], stage_filter_note: 'GROWER / SOW', mandatory_comment: false, mandatory_weight: false },
