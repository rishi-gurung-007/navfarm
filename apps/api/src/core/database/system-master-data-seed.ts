...
export const SYSTEM_ITEM_TYPE_SEED: Array<{
...
}> = [
  {
    ...
    code_prefix: 'RAW_MATERIAL',
    description:
      'Unprocessed input consumed in production (feed ingredients, chemicals, etc.).',
  },
  {
    type_code: 'CONSUMABLE',
    type_name: 'Consumable',
    code_prefix: 'CONSUMABLE',
    description: 'General consumable stock — not a raw material line item.',
  },
  {
    type_code: 'FEED',
    type_name: 'Feed',
    code_prefix: 'FEED',
    description: 'Formulated animal feed.',
  },
  {
    type_code: 'MEDICINE',
    type_name: 'Medicine',
    code_prefix: 'MEDICINE',
    description:
      'Medicine — requires withdrawal_days before a treated animal may be slaughtered.',
  },
  {
    type_code: 'VACCINE',
    type_name: 'Vaccine',
    code_prefix: 'VACCINE',
    description:
      'Vaccine — requires withdrawal_days before a treated animal may be slaughtered.',
  },
  {
    type_code: 'LIVESTOCK',
    type_name: 'Livestock',
    code_prefix: 'LIVESTOCK',
    description: 'Living biological asset (animal) tracked as inventory.',
  },
  {
    type_code: 'SEMI_FINISHED',
    type_name: 'Semi-Finished Good',
    code_prefix: 'SEMI_FINISHED',
    description: 'Partially processed output, consumed further downstream.',
  },
  {
    type_code: 'FINISHED_GOODS',
    type_name: 'Finished Goods',
    code_prefix: 'FINISHED_GOODS',
    description: 'Final saleable output.',
  },
  {
    type_code: 'BY_PRODUCT',
    type_name: 'By-Product',
    code_prefix: 'BY_PRODUCT',
    description: 'Secondary output generated alongside the main product.',
  },
  {
    type_code: 'OVERHEAD',
    type_name: 'Overhead',
    code_prefix: 'OVERHEAD',
    description:
      'Non-physical cost item (labor, utilities) with no stock quantity.',
  },
];
...
export const SYSTEM_LOCATION_TYPE_SEED: Array<{
  ...
  {
    type_code: 'SHED',
    type_name: 'Shed / House',
    code_prefix: 'SHED',
    allowed_parent_types: ['FARM'],
  },
  {
    type_code: 'PEN',
    type_name: 'Pen',
    code_prefix: 'PEN',
    allowed_parent_types: ['SHED'],
  },
  ...
  },
  {
    ...
    type_name: 'Cage',
    code_prefix: 'CAGE',
    allowed_parent_types: ['FARM', 'SHED'],
  },
  {
    type_code: 'STORE',
    type_name: 'Store',
...
export const SYSTEM_BREED_SEED: Array<{
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    breed_code: 'BOVANS-WHITE',
    breed_name: 'Bovans White',
    species_code: 'CHICKEN',
    breed_type: 'LAYER',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_HATCHING',
    breed_code: 'ROSS-308',
    breed_name: 'Ross 308',
    species_code: 'CHICKEN',
    breed_type: 'BREEDER',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    breed_code: 'COBB-500-CB',
    breed_name: 'Cobb 500 (Commercial Broiler)',
    species_code: 'CHICKEN',
    breed_type: 'BROILER',
  },
  {
  ...
  },
  {
    ...
    gestation_days: 114,
    lactation_days: 28,
    productive_life_months: 36,
    residual_value_pct: 10.0,
    productive_life_cycles: 7,
    avg_litter_size_born: 11.5,
    avg_litter_size_weaned: 10.0,
    avg_weaning_weight_kg: 7.0,
    farrowing_rate_pct: 85.0,
    boar_doses_per_week: 4.0,
    boar_productive_life_months: 24,
  },
  {
  ...
  },
  {
    ...
    residual_value_pct: 10.0,
    productive_life_cycles: 7,
    avg_litter_size_born: 12.0,
    avg_litter_size_weaned: 10.5,
    avg_weaning_weight_kg: 6.5,
    farrowing_rate_pct: 87.0,
    boar_doses_per_week: 4.0,
    boar_productive_life_months: 24,
  },
  {
    ...
    gestation_days: 114,
    lactation_days: 27,
    productive_life_months: 30,
    residual_value_pct: 10.0,
    productive_life_cycles: 6,
    avg_litter_size_born: 10.0,
    avg_litter_size_weaned: 8.5,
    avg_weaning_weight_kg: 7.5,
    farrowing_rate_pct: 82.0,
    boar_doses_per_week: 5.0,
    boar_productive_life_months: 30,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_GOAT_SHEEP',
    breed_code: 'BOER-GOAT',
    breed_name: 'Boer Goat',
    species_code: 'GOAT',
    breed_type: 'MEAT',
  },
  {
  ...
  },
  {
    nob_code: 'INSECT',
    lob_code: 'INS_BEE',
    breed_code: 'ITALIAN-BEE',
    breed_name: 'Italian Honey Bee',
    species_code: 'BEE',
    breed_type: 'DUAL_PURPOSE',
  },
];
...
export function forSeededLobs<T extends { lob_code: string }>(
  rows: readonly T[],
): T[] {
  return rows.filter((row) =>
    (SEEDED_LOB_CODES as readonly string[]).includes(row.lob_code),
  );
}
...
export const SYSTEM_ITEM_SEED: Array<{
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    item_code: 'PLT-POL-PULLET',
    item_name: 'Point-of-Lay Pullet',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'PCS',
  },
  {
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    item_code: 'PLT-TABLE-EGG',
    item_name: 'Table Eggs',
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_HATCHING',
    item_code: 'PLT-HATCH-EGG',
    item_name: 'Hatching Egg',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'PCS',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_HATCHING',
    item_code: 'PLT-HATCHED-DOC',
    item_name: 'Hatched Day-Old Chick',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'PCS',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    item_code: 'PLT-BROILER-FEED',
    item_name: 'Broiler Grower Feed',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    item_code: 'PLT-LIVE-BROILER',
    item_name: 'Live Broiler',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_SLAUGHTER',
    item_code: 'PLT-LIVE-BIRD',
    item_name: 'Live Bird (Slaughter Input)',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_SLAUGHTER',
    item_code: 'PLT-DRESSED-CHICKEN',
    item_name: 'Dressed Chicken',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_MILKING',
    item_code: 'LVS-DAIRY-FEED',
    item_name: 'Dairy Cattle Feed',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
  ...
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_PIGGERY',
    item_code: 'LVS-DRESSED-PORK',
    item_name: 'Dressed Pork',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
  ...
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_FRUIT',
    item_code: 'AGR-FRUIT-SAPLING',
    item_name: 'Fruit Sapling',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'PCS',
  },
  {
  ...
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_CROP',
    item_code: 'AGR-SEED-STOCK',
    item_name: 'Seed Stock',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_CROP',
    item_code: 'AGR-HARVEST-CROP',
    item_name: 'Harvested Crop',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'TONNE',
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_SEEDS',
    item_code: 'AGR-FOUNDATION-SEED',
    item_name: 'Foundation Seed',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_SEEDS',
    item_code: 'AGR-CERTIFIED-SEED',
    item_name: 'Certified Seed',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_FISH',
    item_code: 'AQA-FINGERLING',
    item_name: 'Fish Fingerling',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'PCS',
  },
  {
  ...
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_SLAUGHTER',
    item_code: 'AQA-LIVE-FISH',
    item_name: 'Live Fish (Slaughter Input)',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_SLAUGHTER',
    item_code: 'AQA-PROCESSED-FISH',
    item_name: 'Processed Fish',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
    nob_code: 'INSECT',
    lob_code: 'INS_BEE',
    item_code: 'INS-BEE-COLONY',
    item_name: 'Bee Colony',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'BOX',
  },
  {
  ...
  },
  {
    nob_code: 'INSECT',
    lob_code: 'BSF',
    item_code: 'INS-BSF-LARVAE-STOCK',
    item_name: 'BSF Larvae Stock',
    item_type: 'RAW_MATERIAL',
    uom_primary: 'KG',
  },
  {
    nob_code: 'INSECT',
    lob_code: 'BSF',
    item_code: 'INS-BSF-PROCESSED-FRASS',
    item_name: 'Processed BSF Frass',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'KG',
  },
  {
  ...
  },
  {
    nob_code: 'PRODUCTION',
    lob_code: 'FEED_PROD',
    item_code: 'PRD-FINISHED-FEED',
    item_name: 'Finished Feed',
    item_type: 'FINISHED_GOODS',
    uom_primary: 'TONNE',
  },
];
...
export const SYSTEM_PARAMETER_SEED: Array<{
  ...
  parameter_type:
    'CONSUMPTION' | 'MORTALITY' | 'OUTPUT' | 'OVERHEAD' | 'OBSERVATION';
  item_code?: string;
  default_uom?: string;
  ...
  // Poultry
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_REARING',
    parameter_code: 'PARAM-PLT-REARING-FEED',
    parameter_name: 'Starter Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'PLT-STARTER-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 0.05,
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_REARING',
    parameter_code: 'PARAM-PLT-REARING-MORT',
    parameter_name: 'Rearing Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    parameter_code: 'PARAM-PLT-LAYING-FEED',
    parameter_name: 'Layer Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'PLT-LAYER-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 0.11,
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    parameter_code: 'PARAM-PLT-LAYING-MORT',
    parameter_name: 'Laying Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_LAYING',
    parameter_code: 'PARAM-PLT-LAYING-EGG',
    parameter_name: 'Egg Production (Hen-Day Rate)',
    parameter_type: 'OUTPUT',
    item_code: 'PLT-TABLE-EGG',
    default_uom: 'DOZEN',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 0.075,
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_HATCHING',
    parameter_code: 'PARAM-PLT-HATCH-OUTPUT',
    parameter_name: 'Hatch Output',
    parameter_type: 'OUTPUT',
    item_code: 'PLT-HATCHED-DOC',
    default_uom: 'PCS',
  ...
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    parameter_code: 'PARAM-PLT-CB-FEED',
    parameter_name: 'Broiler Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'PLT-BROILER-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 0.09,
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    parameter_code: 'PARAM-PLT-CB-MORT',
    parameter_name: 'Broiler Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_CB',
    parameter_code: 'PARAM-PLT-CB-WEIGHT',
    parameter_name: 'Live Weight Output',
    parameter_type: 'OUTPUT',
    item_code: 'PLT-LIVE-BROILER',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 2.0,
    is_mandatory: true,
  },
  {
    nob_code: 'POULTRY',
    lob_code: 'PLT_SLAUGHTER',
    parameter_code: 'PARAM-PLT-SLAUGHTER-OUTPUT',
    parameter_name: 'Dressed Output',
    parameter_type: 'OUTPUT',
    item_code: 'PLT-DRESSED-CHICKEN',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  // Livestock
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_MILKING',
    parameter_code: 'PARAM-LVS-MILKING-FEED',
    parameter_name: 'Dairy Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'LVS-DAIRY-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 12,
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_MILKING',
    parameter_code: 'PARAM-LVS-MILKING-MORT',
    parameter_name: 'Herd Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_MILKING',
    parameter_code: 'PARAM-LVS-MILKING-YIELD',
    parameter_name: 'Milk Yield',
    parameter_type: 'OUTPUT',
    item_code: 'LVS-RAW-MILK',
    default_uom: 'LITER',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 15,
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_PIGGERY',
    parameter_code: 'PARAM-LVS-PIGGERY-FEED',
    parameter_name: 'Pig Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'LVS-PIG-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 2.2,
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_PIGGERY',
    parameter_code: 'PARAM-LVS-PIGGERY-MORT',
    parameter_name: 'Herd Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
  ...
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_PIGGERY',
    parameter_code: 'PARAM-LVS-PIGGERY-WEIGHT',
    parameter_name: 'Dressed Weight Output',
    parameter_type: 'OUTPUT',
    item_code: 'LVS-DRESSED-PORK',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 65,
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_GOAT_SHEEP',
    parameter_code: 'PARAM-LVS-GOAT-FEED',
    parameter_name: 'Goat Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'LVS-GOAT-FEED',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 1.5,
    is_mandatory: true,
  },
  {
    nob_code: 'LIVESTOCK',
    lob_code: 'LVS_GOAT_SHEEP',
    parameter_code: 'PARAM-LVS-GOAT-MORT',
    parameter_name: 'Herd Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
  ...
  // Agriculture (no herd mortality — output/yield-driven instead)
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_FRUIT',
    parameter_code: 'PARAM-AGR-FRUIT-YIELD',
    parameter_name: 'Fruit Yield',
    parameter_type: 'OUTPUT',
    item_code: 'AGR-FRESH-FRUIT',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_CROP',
    parameter_code: 'PARAM-AGR-CROP-YIELD',
    parameter_name: 'Crop Yield',
    parameter_type: 'OUTPUT',
    item_code: 'AGR-HARVEST-CROP',
    default_uom: 'TONNE',
    qty_method: 'PER_BATCH',
  ...
  },
  {
    nob_code: 'AGRI',
    lob_code: 'AGRI_SEEDS',
    parameter_code: 'PARAM-AGR-SEEDS-OUTPUT',
    parameter_name: 'Seed Multiplication Output',
    parameter_type: 'OUTPUT',
    item_code: 'AGR-CERTIFIED-SEED',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  // Aquaculture
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_FISH',
    parameter_code: 'PARAM-AQA-FISH-FEED',
    parameter_name: 'Fish Feed Consumption',
    parameter_type: 'CONSUMPTION',
    item_code: 'AQA-FISH-FEED',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  },
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_FISH',
    parameter_code: 'PARAM-AQA-FISH-MORT',
    parameter_name: 'Pond Mortality',
    parameter_type: 'MORTALITY',
    default_uom: 'PCS',
    qty_method: 'MANUAL_AT_ENTRY',
    is_mandatory: true,
  },
  {
    nob_code: 'AQUA',
    lob_code: 'AQA_SLAUGHTER',
    parameter_code: 'PARAM-AQA-SLAUGHTER-OUTPUT',
    parameter_name: 'Processed Fish Output',
    parameter_type: 'OUTPUT',
    item_code: 'AQA-PROCESSED-FISH',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  // Insect farming
  {
    nob_code: 'INSECT',
    lob_code: 'INS_BEE',
    parameter_code: 'PARAM-INS-BEE-YIELD',
    parameter_name: 'Honey Yield',
    parameter_type: 'OUTPUT',
    item_code: 'INS-RAW-HONEY',
    default_uom: 'KG',
    qty_method: 'PER_UNIT',
    default_qty_per_unit: 20,
    is_mandatory: true,
  },
  {
    nob_code: 'INSECT',
    lob_code: 'BSF',
    parameter_code: 'PARAM-INS-BSF-OUTPUT',
    parameter_name: 'Frass Output',
    parameter_type: 'OUTPUT',
    item_code: 'INS-BSF-PROCESSED-FRASS',
    default_uom: 'KG',
    qty_method: 'PER_BATCH',
  ...
  // Feed production
  {
    nob_code: 'PRODUCTION',
    lob_code: 'FEED_PROD',
    parameter_code: 'PARAM-PRD-FEED-GRAIN',
    parameter_name: 'Raw Grain Usage',
    parameter_type: 'CONSUMPTION',
    item_code: 'PRD-RAW-GRAIN',
    default_uom: 'TONNE',
    qty_method: 'PER_BATCH',
  ...
  },
  {
    nob_code: 'PRODUCTION',
    lob_code: 'FEED_PROD',
    parameter_code: 'PARAM-PRD-FEED-OUTPUT',
    parameter_name: 'Finished Feed Output',
    parameter_type: 'OUTPUT',
    item_code: 'PRD-FINISHED-FEED',
    default_uom: 'TONNE',
    qty_method: 'PER_BATCH',
...
const LEGACY_STAGE_SEED: Array<{
...
}> = [
  {
    ...
    auto_move_on_day: 30,
    next_stage_code: 'GILT_GROWER',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description:
      'Animals kept isolated for health monitoring before entering main production.',
  },
  {
    stage_code: 'GILT_GROWER',
    stage_name: 'Gilt Grower Phase',
    stage_category: 'PRE_PRODUCTIVE',
    stage_sequence: 2,
    typical_duration_days: 77,
    min_days_before_move: 56,
    transition_trigger: 'MANUAL',
    next_stage_code: 'FLUSH_SERVICE',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description: 'Growing phase for gilts before they enter breeding.',
  },
  {
    stage_code: 'FLUSH_SERVICE',
    stage_name: 'Flush and Service / AI',
    stage_category: 'PRE_PRODUCTIVE',
    stage_sequence: 3,
    typical_duration_days: 10,
    min_days_before_move: 5,
    transition_trigger: 'EVENT_BASED',
    next_stage_code: 'DRY_SOW_GESTATION',
    alt_next_stage_code: 'GILT_GROWER',
    alt_trigger_condition: 'CONCEPTION_FAILED',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description:
  ...
  {
    stage_code: 'DRY_SOW_GESTATION',
    stage_name: 'Dry Sow / Gestation',
    stage_category: 'PRODUCTIVE',
    stage_sequence: 4,
    typical_duration_days: 110,
    min_days_before_move: 90,
    transition_trigger: 'EVENT_BASED',
    next_stage_code: 'FARROWING',
    alt_next_stage_code: 'FLUSH_SERVICE',
    alt_trigger_condition: 'PREGNANCY_FAILED',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description: 'Confirmed pregnancy through to term.',
  },
  {
    stage_code: 'FARROWING',
    stage_name: 'Farrowing',
    stage_category: 'OUTPUT',
    stage_sequence: 5,
    typical_duration_days: 3,
    min_days_before_move: 1,
    transition_trigger: 'EVENT_BASED',
    next_stage_code: 'LACTATION',
    data_entry_form: 'FARROWING',
    show_on_animal_card: true,
    stage_description: 'Birth of the litter.',
  },
  {
    stage_code: 'LACTATION',
    stage_name: 'Lactation / Nursing',
    stage_category: 'PRODUCTIVE',
    stage_sequence: 6,
    typical_duration_days: 28,
    min_days_before_move: 21,
    transition_trigger: 'AUTO_BY_DAY',
    auto_move_on_day: 28,
    next_stage_code: 'WEANING',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description: 'Nursing period following farrowing.',
  },
  {
    stage_code: 'WEANING',
    stage_name: 'Weaning',
    ...
    transition_trigger: 'EVENT_BASED',
    next_stage_code: 'FLUSH_SERVICE',
    alt_trigger_condition: 'PARITY_LIMIT_REACHED',
    data_entry_form: 'WEANING',
    show_on_animal_card: true,
    stage_description:
      'Piglets separated from the sow; sow returns to the breeding cycle.',
  },
  {
    stage_code: 'BOAR_AI',
    stage_name: 'Boar AI Station',
    stage_category: 'PRODUCTIVE',
    stage_sequence: 8,
    min_days_before_move: 30,
    transition_trigger: 'MANUAL',
    next_stage_code: 'BOAR_AI',
    alt_next_stage_code: 'DISPOSED',
    alt_trigger_condition: 'END_OF_PRODUCTIVE_LIFE',
    data_entry_form: 'STANDARD',
    show_on_animal_card: true,
    stage_description: 'Ongoing semen collection station for an active boar.',
  },
  {
    stage_code: 'CB_GROWER',
    stage_name: 'CB Grower Phase',
    stage_category: 'PRE_PRODUCTIVE',
    stage_sequence: 9,
    typical_duration_days: 77,
    min_days_before_move: 60,
    transition_trigger: 'KPI_BASED',
    next_stage_code: 'SLAUGHTER',
    data_entry_form: 'STANDARD',
    show_on_animal_card: false,
    stage_description:
      'Commercial batch grow-out phase for weaned piglets bound for market.',
  },
  {
    stage_code: 'SLAUGHTER',
    stage_name: 'Slaughter',
    stage_category: 'DISPOSAL',
    stage_sequence: 10,
    typical_duration_days: 1,
    min_days_before_move: 1,
    transition_trigger: 'EVENT_BASED',
    next_stage_code: 'DISPOSED',
    data_entry_form: 'SLAUGHTER',
    show_on_animal_card: false,
    stage_description:
  ...
  {
    stage_code: 'DISPOSED',
    stage_name: 'Disposed / End of Life',
    stage_category: 'DISPOSAL',
    stage_sequence: 11,
    ...
    show_on_animal_card: true,
    stage_description:
      'Terminal stage — animal sold, slaughtered, or deceased.',
  },
];
...
export const SYSTEM_NO_SERIES_SEED: Array<{
  ...
  {
    series_code: 'ITEM_TYPE',
    series_name: 'Item Type Code',
    document_type: 'ITEM_TYPE',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['type_name'],
  },
  {
    series_code: 'ITEM_ATTRIBUTE',
    series_name: 'Item Attribute Code',
    document_type: 'ITEM_ATTRIBUTE',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['attribute_name'],
  },
  {
    series_code: 'LOCATION_TYPE',
    series_name: 'Location Type Code',
    document_type: 'LOCATION_TYPE',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
  ...
  {
    series_code: 'UOM',
    series_name: 'Unit of Measure Code',
    document_type: 'UOM',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['uom_name'],
  },
  ...
  {
    series_code: 'ITEM_CATEGORY',
    series_name: 'Item Category Code',
    document_type: 'ITEM_CATEGORY',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['category_name'],
  },
  ...
  {
    series_code: 'STAGE',
    series_name: 'Stage Code',
    document_type: 'STAGE',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['stage_name'],
  },
  ...
  {
    series_code: 'SPECIES',
    series_name: 'Species Code',
    document_type: 'SPECIES',
    separator: '-',
    seq_length: 0,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['species_name'],
  },
  ...
  // built
  {
    ...
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['item_type', 'category_id', 'sub_category'],
  },
  ...
  {
    series_code: 'BREED_LIFECYCLE_STAGE',
    series_name: 'Breed Lifecycle Stage Code',
    document_type: 'BREED_LIFECYCLE_STAGE',
    separator: '-',
    seq_length: 3,
    reset_frequency: 'NEVER',
    allow_manual: true,
    code_segments: ['breed_id', 'stage_id'],
  },

  // serial
  {
    series_code: 'BATCH',
    series_name: 'Batch Number',
    document_type: 'BATCH',
    prefix: 'BATCH',
    separator: '-',
    seq_length: 6,
  ...
  {
    series_code: 'CUSTOMER',
    series_name: 'Customer Code',
  ...
  {
    series_code: 'RESOURCE',
    series_name: 'Resource Code',
  ...
  {
    series_code: 'UOM_CONVERSION',
    series_name: 'UOM Conversion Code',
    document_type: 'UOM_CONVERSION',
    prefix: 'CONV',
    separator: '-',
    seq_length: 3,
    reset_frequency: 'NEVER',
  ...
  {
    series_code: 'FEED_FORMULA',
    series_name: 'Feed Formula Code',
    document_type: 'FEED_FORMULA',
    prefix: 'FORM',
    separator: '-',
    seq_length: 3,
    reset_frequency: 'NEVER',
  ...
  {
    series_code: 'COST_CENTER',
    series_name: 'Cost Center Code (typed, not generated)',
  ...
  {
    series_code: 'GL_ACCOUNT',
    series_name: 'GL Account Code (typed; BC-owned catalog)',
    document_type: 'GL_ACCOUNT',
    prefix: 'GL',
    separator: '-',
    seq_length: 3,
    reset_frequency: 'NEVER',
  ...
  {
    series_code: 'GL_MAPPING',
    series_name: 'GL Mapping Code',
    document_type: 'GL_MAPPING',
    prefix: 'GLMAP',
    separator: '-',
    seq_length: 3,
    reset_frequency: 'NEVER',
  ...
  ...(['YORKSHIRE', 'LARGE_WHITE'] as const).flatMap((breed_code) => [
    {
      breed_code,
      stage_code: 'QUARANTINE',
      calc_unit: 'DAY' as const,
      period_from: 1,
      period_to: 30,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 1.5,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 45.0,
      std_adg_gpd: 350,
      std_fcr: 4.3,
      std_mortality_rate_pct: 1.0,
      kpi_lower_limit: 300,
      kpi_upper_limit: 500,
      alert_severity: 'WARNING' as const,
      notes:
        'Isolation period. Monitor respiratory and enteric disease. Vaccinate per schedule. Target BCS 3.0 at exit.',
    },
    {
      breed_code,
      stage_code: 'GILT_GROWER',
      ...
      period_to: 77,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 2.2,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 125.0,
      std_adg_gpd: 800,
      std_fcr: 2.75,
      std_mortality_rate_pct: 0.5,
      kpi_lower_limit: 700,
      kpi_upper_limit: 950,
      alert_severity: 'WARNING' as const,
      notes:
        'Grow gilt to service weight 120-135 kg. ADG target 800 g/day. Flush feeding starts Day 70.',
    },
    {
      breed_code,
      stage_code: 'FLUSH_SERVICE',
      ...
      period_to: 10,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 3.0,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 128.0,
      std_mortality_rate_pct: 0.2,
      alert_severity: 'INFO' as const,
      notes:
        'Increase feed 2-3 kg/day to stimulate ovulation. Record AI/mating date. Confirm conception at Day 21 scan.',
    },
    {
      breed_code,
      stage_code: 'DRY_SOW_GESTATION',
      ...
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 165.0,
      std_adg_gpd: 300,
      std_mortality_rate_pct: 0.3,
      kpi_lower_limit: 200,
      kpi_upper_limit: 450,
      alert_severity: 'WARNING' as const,
      notes:
        'Maintain BCS 3.0-3.5. Increase to 3.0 kg/day from Day 90. Move to farrowing crate Day 110.',
    },
    {
      breed_code,
      stage_code: 'FARROWING',
      ...
      feed_qty_per_head_per_day_kg: 1.5,
      feed_wastage_pct: 0,
      output_item_code: 'LVS-PIGLET',
      output_uom: 'PCS',
      std_output_qty: 11.5,
      std_mortality_rate_pct: 0.5,
      kpi_lower_limit: 9.0,
      kpi_upper_limit: 14.0,
      alert_severity: 'CRITICAL' as const,
      notes:
        'Record litter born alive and stillbirths. KPI: live born >= 11. Ramp to lactation ration Day 3.',
    },
    {
      breed_code,
      stage_code: 'LACTATION',
      ...
      period_to: 28,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 6.5,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 155.0,
      std_mortality_rate_pct: 0.3,
      output_item_code: 'LVS-PIGLET',
      output_uom: 'PCS',
      std_output_qty: 10.0,
      kpi_lower_limit: 9.0,
      kpi_upper_limit: 12.0,
      alert_severity: 'WARNING' as const,
      notes:
        'Ad-lib sow feed to maximise milk yield. Wean at 28 days (min 21). Target weaning weight 7 kg/piglet.',
    },
    {
      breed_code,
      stage_code: 'WEANING',
      ...
      output_uom: 'PCS',
      std_output_qty: 10.0,
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes:
        'Record weaning weight. Sow weaning-to-service interval target <= 5 days.',
    },
    {
      breed_code,
      stage_code: 'BOAR_AI',
      calc_unit: 'WEEK' as const,
      period_from: 1,
      period_to: 104,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 2.8,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 200.0,
      std_mortality_rate_pct: 0.0,
      kpi_lower_limit: 3.0,
      kpi_upper_limit: 6.0,
      alert_severity: 'WARNING' as const,
      notes:
        'Collect 4 doses/week. Evaluate semen motility each collection. Record libido score.',
    },
    {
      breed_code,
      stage_code: 'CB_GROWER',
      ...
      feed_qty_per_head_per_day_kg: 2.5,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 115.0,
      std_adg_gpd: 800,
      std_fcr: 2.8,
      std_mortality_rate_pct: 1.5,
      output_item_code: 'LVS-DRESSED-PORK',
      output_uom: 'KG',
      std_output_qty: 82.0,
      kpi_lower_limit: 700,
      kpi_upper_limit: 950,
      alert_severity: 'CRITICAL' as const,
      notes:
        'Target market weight 115 kg at 77 days. FCR must stay <= 2.8. Withdrawal periods mandatory.',
    },
    {
      breed_code,
      stage_code: 'SLAUGHTER',
      ...
      alert_severity: 'INFO' as const,
      notes:
        'Check withdrawal periods. Record live weight, dressed weight, dressing pct, condemnations.',
    },
    {
      breed_code,
      stage_code: 'DISPOSED',
      ...
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes: 'Record disposal reason: sold, slaughtered, died, culled.',
    },
  ]),
  ...
  ...(['LANDRACE'] as const).flatMap((breed_code) => [
    {
      ...
      kpi_upper_limit: 500,
      alert_severity: 'WARNING' as const,
      notes: 'Same quarantine protocol as Yorkshire.',
    },
    {
      breed_code,
      stage_code: 'GILT_GROWER',
      ...
      kpi_upper_limit: 950,
      alert_severity: 'WARNING' as const,
      notes: 'Landrace gilts service weight 120-130 kg.',
    },
    {
      breed_code,
      stage_code: 'FLUSH_SERVICE',
      ...
      std_mortality_rate_pct: 0.2,
      alert_severity: 'INFO' as const,
      notes: 'High farrowing rate 87%. Confirm conception scan Day 21.',
    },
    {
      breed_code,
      stage_code: 'DRY_SOW_GESTATION',
      ...
      feed_qty_per_head_per_day_kg: 2.5,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 168.0,
      std_adg_gpd: 295,
      std_mortality_rate_pct: 0.3,
      kpi_lower_limit: 200,
      kpi_upper_limit: 440,
      alert_severity: 'WARNING' as const,
      notes: 'Landrace gestation 115 days. Maintain BCS 3.0-3.5.',
    },
    {
      breed_code,
      stage_code: 'FARROWING',
      ...
      std_output_qty: 12.0,
      std_mortality_rate_pct: 0.5,
      kpi_lower_limit: 10.0,
      kpi_upper_limit: 15.0,
      alert_severity: 'CRITICAL' as const,
      notes: 'Largest litter of 4 breeds. Target live born >= 12.',
    },
    {
      breed_code,
      stage_code: 'LACTATION',
      ...
      feed_qty_per_head_per_day_kg: 6.5,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 152.0,
      std_mortality_rate_pct: 0.3,
      output_item_code: 'LVS-PIGLET',
      output_uom: 'PCS',
      std_output_qty: 10.5,
      kpi_lower_limit: 9.5,
      kpi_upper_limit: 13.0,
      alert_severity: 'WARNING' as const,
      notes: 'Good milking ability. Target 10.5 weaned/litter.',
    },
    {
      breed_code,
      stage_code: 'WEANING',
      ...
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes: 'Weaning weight target 6.5 kg.',
    },
    {
      breed_code,
      stage_code: 'BOAR_AI',
      ...
      feed_qty_per_head_per_day_kg: 2.8,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 195.0,
      std_mortality_rate_pct: 0.0,
      kpi_lower_limit: 3.0,
      kpi_upper_limit: 6.0,
      alert_severity: 'WARNING' as const,
      notes: 'Landrace boar AI station standard protocol.',
    },
    {
      breed_code,
      stage_code: 'CB_GROWER',
      ...
      kpi_upper_limit: 950,
      alert_severity: 'CRITICAL' as const,
      notes: 'Slightly lower FCR than Yorkshire in finisher. Monitor closely.',
    },
    {
      breed_code,
      stage_code: 'SLAUGHTER',
      ...
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes: 'Record live weight, dressed weight, dressing pct.',
    },
    {
      breed_code,
      stage_code: 'DISPOSED',
  ...
  ...(['DUROC'] as const).flatMap((breed_code) => [
    {
      ...
      period_to: 30,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 1.8,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 48.0,
      std_adg_gpd: 420,
      std_fcr: 4.0,
      std_mortality_rate_pct: 1.0,
      kpi_lower_limit: 350,
      kpi_upper_limit: 550,
      alert_severity: 'WARNING' as const,
      notes: 'Duroc grows faster in quarantine. Same health protocol applies.',
    },
    {
      breed_code,
      stage_code: 'GILT_GROWER',
      ...
      period_to: 77,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 2.3,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 130.0,
      std_adg_gpd: 900,
      std_fcr: 2.6,
      std_mortality_rate_pct: 0.5,
      kpi_lower_limit: 800,
      kpi_upper_limit: 1050,
      alert_severity: 'WARNING' as const,
      notes: 'Higher ADG than maternal breeds. Service weight 125-140 kg.',
    },
    {
      breed_code,
      stage_code: 'FLUSH_SERVICE',
      ...
      feed_qty_per_head_per_day_kg: 3.0,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 133.0,
      std_mortality_rate_pct: 0.2,
      alert_severity: 'INFO' as const,
      notes: 'Farrowing rate 82%. Confirm scan Day 21.',
    },
    {
      breed_code,
      stage_code: 'DRY_SOW_GESTATION',
      ...
      period_to: 114,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 2.7,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 175.0,
      std_adg_gpd: 320,
      std_mortality_rate_pct: 0.3,
      kpi_lower_limit: 250,
      kpi_upper_limit: 480,
      alert_severity: 'WARNING' as const,
      notes: 'Heavier sow requires slightly higher gestation ration.',
    },
    {
      breed_code,
      stage_code: 'FARROWING',
      ...
      alert_severity: 'CRITICAL' as const,
      notes:
        'Lower litter size typical of terminal sire. Piglets heavier at birth.',
    },
    {
      breed_code,
      stage_code: 'LACTATION',
      ...
      feed_qty_per_head_per_day_kg: 6.5,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 158.0,
      std_mortality_rate_pct: 0.3,
      output_item_code: 'LVS-PIGLET',
      output_uom: 'PCS',
      std_output_qty: 8.5,
      kpi_lower_limit: 7.5,
      kpi_upper_limit: 11.0,
      alert_severity: 'WARNING' as const,
      notes:
        'Duroc 27-day lactation. Heavier piglets at weaning (target 7.5 kg).',
    },
    {
      breed_code,
      stage_code: 'WEANING',
      ...
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes: 'Weaning weight target 7.5 kg -- heavier than maternal breeds.',
    },
    {
      breed_code,
      stage_code: 'BOAR_AI',
      ...
      feed_qty_per_head_per_day_kg: 3.0,
      feed_wastage_pct: 3.0,
      std_body_weight_kg: 230.0,
      std_mortality_rate_pct: 0.0,
      kpi_lower_limit: 4.0,
      kpi_upper_limit: 7.0,
      alert_severity: 'WARNING' as const,
      notes:
        'Duroc boar extended productive life (30 months). Higher dose count.',
    },
    {
      breed_code,
      stage_code: 'CB_GROWER',
      ...
      period_to: 77,
      feed_item_code: 'LVS-PIG-FEED',
      feed_qty_per_head_per_day_kg: 2.6,
      feed_wastage_pct: 5.0,
      std_body_weight_kg: 120.0,
      std_adg_gpd: 950,
      std_fcr: 2.55,
      std_mortality_rate_pct: 1.5,
      output_item_code: 'LVS-DRESSED-PORK',
      ...
      std_output_qty: 88.0,
      kpi_lower_limit: 850,
      kpi_upper_limit: 1100,
      alert_severity: 'CRITICAL' as const,
      notes: 'Best FCR of the 4 breeds. Premium terminal sire for market pigs.',
    },
    {
      breed_code,
      stage_code: 'SLAUGHTER',
      ...
      std_mortality_rate_pct: 0.0,
      alert_severity: 'INFO' as const,
      notes: 'Higher dressing percentage expected. Record condemnations.',
    },
    {
      breed_code,
      stage_code: 'DISPOSED',
...
export const SYSTEM_BREED_LIFECYCLE_SEED: typeof LEGACY_BREED_LIFECYCLE_SEED =
  LEGACY_BREED_LIFECYCLE_SEED.flatMap((row) => {
    ...
    return [
      {
        ...row,
        stage_code: code,
        period_to: stage.typical_duration_days ?? row.period_to,
        notes:
          'Illustrative demo benchmark, not a client-approved feeding protocol. Stage duration aligned to BBP §1.7; confirm breed-specific targets before live use.',
      },
    ];
  });
