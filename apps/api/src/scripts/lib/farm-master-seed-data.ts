...
export const FARM_RESOURCE_SEED: FarmResourceSeedRow[] = [
  ...
  },
  {
    ...
    costCentre: '280',
    department: 'Farm Operations',
    assetCode: 'FA-PE000008887',
    capacity: 80.0,
    capacityUom: 'KW',
    nextServiceDate: '2027-01-03',
  },
  {
    farm: 'PORTA',
    code: 'PWH - 02',
...
export const FARM_BREED_SEED: FarmBreedSeedRow[] = [
  {
    ...
    gestationDays: 116,
    lactationDays: 28,
    productiveLifeMonths: 46,
    productiveLifeCycles: 10,
    avgLitterSizeBorn: 15.0,
    avgLitterSizeWeaned: 13.8,
    avgWeaningWeightKg: 7.5,
  ...
  },
  {
    ...
    gestationDays: 116,
    lactationDays: 28,
    productiveLifeMonths: 42,
    productiveLifeCycles: 8,
    avgLitterSizeBorn: 16.3306,
    avgLitterSizeWeaned: 15.3508,
    avgWeaningWeightKg: 8.0,
    boarProductiveLifeMonths: 29,
  },
];
