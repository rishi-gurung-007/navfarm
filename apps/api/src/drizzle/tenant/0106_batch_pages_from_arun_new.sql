...
--> statement-breakpoint
ALTER TABLE `batch_daily_data_target` DROP FOREIGN KEY `bddt_entry_fk`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data_target` DROP FOREIGN KEY `bddt_animal_fk`;
--> statement-breakpoint
DROP TABLE `batch_daily_data_target`;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE `batch_daily_data` ADD CONSTRAINT `uq_batch_daily_data_line_date` UNIQUE(`line_id`,`entry_date`,(coalesce(`animal_id`, '')));
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP INDEX `uq_batch_daily_data_line_date_active`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `active_slot`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `status`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `version`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `target_scope`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `supersedes_entry_id`;
--> statement-breakpoint
ALTER TABLE `batch_daily_data` DROP COLUMN `superseded_at`;
