...
const locationType: MasterDataConfig = {
  ...
  description:
    'Location classifications, hierarchy rules and prefixes for generated location codes.',
  ...
  fields: [
    {
      ...
      type: 'select-entity',
      entityEndpoint: '/setup/wizard/nobs',
      entityValueKey: 'nob_id',
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this location type is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      type: 'select-entity',
      entityEndpoint: '/setup/wizard/lobs/{value}',
      entityValueKey: 'lob_id',
      entityLabelKeys: ['lob_code', 'lob_name'],
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this location type is shared across all LOBs under the selected NOB.',
    },
    ...
    },
    {
      ...
      required: true,
      placeholder: 'FARM',
      helpText: 'Future locations use PREFIX-001, PREFIX-002, and so on.',
    },
    {
      key: 'allowed_parent_types',
      ...
      excludeValuesOf: ['type_code'],
      showInLookup: true,
      helpText:
        'Leave empty for a level 1 root type. Otherwise choose the location type(s) allowed at the immediately preceding level.',
    },
  ],
};
...
const location: MasterDataConfig = {
  ...
  label: 'Locations',
  description:
    'One hierarchy for farms, sheds, pens, cages, stores, quarantine areas and silos.',
  apiBase: '/location',
  idKey: 'location_id',
  group: 'Farm Operations',
  isPrimary: true,
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this location is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this location is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'location_code',
      ...
      readOnly: true,
      helpText:
        'Generated from the selected Location Type prefix and kept permanently.',
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: '48 Peg, Bulawayo Road',
      section: 'Identification',
    },
    {
      key: 'location_type',
    ...
    },
    {
      ...
      entityValueKey: 'location_id',
      entityLabelKeys: ['location_code', 'location_name'],
      dependsOn: 'location_type',
      restrictOptionsBy: {
        selectorKey: 'location_type',
        selectorEntityEndpoint: '/location-type',
        selectorCodeKey: 'type_code',
        allowListKey: 'allowed_parent_types',
        optionCodeKey: 'location_type',
        hideWhenEmpty: true,
      },
      helpText:
        'Only locations from the immediately preceding hierarchy level are available. Level 1 root types, such as Farm, have no Parent Location field.',
      section: 'Identification',
    },
    {
      key: 'location_level',
      ...
      type: 'number',
      hideInForm: true,
      helpText: 'Computed from the parent location.',
    },
    {
      key: 'area_size',
      label: 'Area Size',
    ...
    },
    {
      ...
      label: 'Area UOM',
      type: 'select-entity',
      entityEndpoint: '/uom?uomType=AREA',
      entityValueKey: 'uom_code',
      entityLabelKeys: ['uom_code', 'uom_name'],
      section: 'Identification',
    },
    {
      key: 'max_capacity',
    ...
    },
    {
      ...
      type: 'select-entity',
      required: true,
      entityEndpoint: '/uom?uomType=COUNT',
      entityValueKey: 'uom_code',
      entityLabelKeys: ['uom_code', 'uom_name'],
      section: 'Identification',
    },
    {
      ...
      type: 'select',
      options: ['STORE', 'SILO'].map((v) => ({ value: v, label: v })),
      section: 'Identification',
    },
    {
      key: 'silo_capacity_kg',
      label: 'Silo Capacity (KG)',
      type: 'number',
      step: '0.01',
      visibleWhen: { anyOf: [{ key: 'storage_type', equals: 'SILO' }] },
      requiredWhen: { anyOf: [{ key: 'storage_type', equals: 'SILO' }] },
      helpText: 'Required when Storage Location is SILO.',
      section: 'Identification',
    },
    {
      key: 'silo_reorder_days',
      label: 'Silo Reorder Days',
      type: 'number',
      visibleWhen: { anyOf: [{ key: 'storage_type', equals: 'SILO' }] },
      requiredWhen: { anyOf: [{ key: 'storage_type', equals: 'SILO' }] },
      helpText: 'Required when Storage Location is SILO.',
    ...
    {
      key: 'downtime_days_required',
      label: 'Downtime Days Required',
      type: 'number',
      helpText: 'Empty days required between batches for biosecurity.',
      section: 'Identification',
    },
    ...
    {
      key: 'storage_name',
      label: 'Silo / Store Name',
      type: 'text',
      placeholder: 'MGH1',
      visibleWhen: {
        anyOf: [{ key: 'storage_type', equals: ['STORE', 'SILO'] }],
      },
      helpText:
        'The name or number this silo or store is known by on the farm.',
      section: 'Identification',
    },
    ...
    // lifecycle sheets read it: a stage's feed is "bagged" at MFH, "Bulk" at MSL.
    {
      ...
      type: 'boolean',
      helpText:
        'On when feed arrives here in bags rather than blown into a silo.',
      section: 'Identification',
    },
  ],
};
...
const stage: MasterDataConfig = {
  ...
  label: 'Stages',
  description:
    'Production lifecycle stages per NOB/LOB (e.g. piggery: Quarantine → Gilt Grower → ... → Disposed) — sequencing and transition rules for batches.',
  apiBase: '/stage',
  idKey: 'stage_id',
  group: 'Production',
  isPrimary: true,
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      section: 'Identification',
      options: ['PRE_PRODUCTIVE', 'PRODUCTIVE', 'OUTPUT', 'DISPOSAL'].map(
    ...
    },
    {
      ...
      type: 'number',
      required: true,
      helpText: 'Must be unique per Line of Business.',
      section: 'Identification',
    },
    {
    ...
    {
      key: 'min_days_before_move',
      label: 'Min Days Before Move',
      type: 'number',
      helpText: 'Minimum days in this stage before a transition is allowed.',
      section: 'Duration',
    },
    {
    ...
    },
    {
      ...
      required: true,
      section: 'Transitions',
      options: ['AUTO_BY_DAY', 'MANUAL', 'EVENT_BASED', 'KPI_BASED'].map(
        (v) => ({ value: v, label: v.replace(/_/g, ' ') }),
      ),
    },
    {
      ...
      entityLabelKeys: ['stage_code', 'stage_name'],
      helpText: 'Leave blank for a terminal stage.',
      section: 'Transitions',
    },
    {
    ...
    },
    {
      ...
      type: 'select',
      section: 'Data Entry',
      options: ['STANDARD', 'FARROWING', 'WEANING', 'SLAUGHTER'].map((v) => ({
        value: v,
        label: v,
      })),
    },
    {
      key: 'scheduler_auto_create',
      label: 'Auto-Create Scheduler',
      type: 'boolean',
      section: 'Data Entry',
    },
    {
      key: 'show_on_animal_card',
      label: 'Show on Animal Card',
      type: 'boolean',
      section: 'Data Entry',
    },
    {
      key: 'required_kpi_to_pass',
      label: 'Required KPI to Pass',
      type: 'json',
      section: 'Data Entry',
      helpText:
        'KPI checks validated before a stage transition, e.g. [{"metric":"BODY_WEIGHT","min_value":100}]. A failure warns; a farmer may override with approval.',
    },
  ],
};
...
const numberSeries: MasterDataConfig = {
  ...
  description:
    'Concurrency-safe business-code generators (e.g. "BATCH" → BATCH-000001) — other modules call these by series code instead of counting rows themselves.',
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank for a series shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
    ...
    },
    {
      ...
      required: true,
      createOnly: true,
      entityEndpoint: '/number-series/masters',
      entityValueKey: 'master_key',
      entityLabelKeys: ['master_key'],
      helpText:
        'The master this series generates codes for. For a type-scoped series (e.g. sheds only) create it as MASTER_TYPE — LOCATION_SHED.',
    },
    {
      key: 'series_name',
      label: 'Series Name',
    ...
    // already uses — `current` keeps an edit able to show its own value.
    {
      ...
      entityEndpoint: '/number-series/masters?all=true',
      entityValueKey: 'master_key',
      entityLabelKeys: ['master_key'],
      helpText:
        "The master these codes belong to. Code Built From then offers that master's own fields.",
    },
    ...
    // invisible survives in the value.
    {
      ...
      type: 'boolean',
      filterOnly: true,
      seedFromValueOf: 'prefix',
      clearsWhenOff: { prefix: '', prefix_position: 'END' },
      helpText:
        'A fixed piece of text in the code, like ITM. Off for masters coded entirely from their own fields.',
    },
    {
      key: 'prefix',
      label: 'Prefix',
      ...
      requiredWhen: { anyOf: [{ key: 'use_prefix', equals: true }] },
    },
    ...
    // where it identifies nothing. Ignored when no prefix is set.
    {
      ...
      type: 'select',
      options: [
        { value: 'END', label: 'Last — just before the number' },
        { value: 'START', label: 'First — at the start of the code' },
      ],
    ...
    {
      key: 'seq_separator',
      label: 'Separator Before the Number',
      type: 'select',
      ...
      helpText:
        'Only when it differs — Location joins its path with / but its number with -.',
    },
    ...
    {
      key: 'use_sequence',
      label: 'Use a Running Number',
      type: 'boolean',
      filterOnly: true,
      seedFromValueOf: 'seq_length',
      clearsWhenOff: { seq_length: 0, seq_separator: '' },
      helpText:
        'Off when the fields alone make the code unique — a breed IS Large White, and LARGE_WHITE-001 would count something already unique. A repeat is then refused rather than numbered.',
    },
    {
      key: 'seq_length',
      ...
      placeholder: '3',
      visibleWhen: { anyOf: [{ key: 'use_sequence', equals: true }] },
      requiredWhen: { anyOf: [{ key: 'use_sequence', equals: true }] },
      helpText: 'A minimum width, not a limit — after 999 the next is 1000.',
    },
    {
      key: 'reset_frequency',
      label: 'Reset Frequency',
      type: 'select',
      options: ['NEVER', 'MONTHLY', 'YEARLY'].map((v) => ({
        value: v,
        label: v,
      })),
    },
    ...
    {
      key: 'code_segments',
      label: 'Code Built From',
      type: 'field-list',
      fieldsOf: 'document_type',
      helpText:
        'Ordered, and any mix. Leave empty for prefix then number. Location: parent location, then location type, then the number.',
    },
    {
      key: 'allow_manual',
      label: 'Allow Manual Entry',
      type: 'boolean',
      helpText: 'Let a user type their own code instead of generating one.',
    },
    {
      key: 'current_seq',
    ...
    {
      key: 'last_generated_code',
      label: 'Last Generated Code',
      type: 'text',
      hideInForm: true,
    },
  ],
...
const activity: MasterDataConfig = {
  ...
  label: 'Activities',
  description:
    'Standard activities catalog (feed, vaccines, weigh, tasks) used across schedulers and daily data entry.',
  apiBase: '/activity',
  idKey: 'activity_id',
  group: 'Production',
  isPrimary: true,
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'e.g. MORN_FEED',
      createOnly: true,
      helpText:
        'Short unique uppercase code (e.g. MORN_FEED) for lookups and reporting.',
    },
    {
      key: 'activity_name',
      label: 'Activity Name',
    ...
    },
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this activity is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this activity is shared across all LOBs under the selected NOB.',
    },
    {
      key: 'description',
      label: 'Description',
      type: 'textarea',
      placeholder: 'Optional notes or instructions for this activity',
    },
  ],
};
...
const animal: MasterDataConfig = {
  bcFields: [
    ...
    {
      key: 'bc_converted_to_inventory_date',
      label: 'Converted to Inventory Date',
    },
  ...
  description:
    'Individual animal lifetime identity — lineage, entry, cost, current stage/location. Never physically deleted; use Dispose to record sale/slaughter/death.',
  apiBase: '/animal',
  idKey: 'animal_id',
  group: 'Piggery',
  isPrimary: true,
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      section: 'Identification',
      options: ['SOW', 'BOAR', 'GILT', 'PIGLET', 'COMMERCIAL_PIG'].map((v) => ({
        value: v,
        label: v.replace(/_/g, ' '),
      })),
    },
    {
      ...
      required: true,
      searchable: true,
      entityEndpoint: '/breed',
      entityValueKey: 'breed_id',
      entityLabelKeys: ['breed_code', 'breed_name'],
      section: 'Identification',
    },
    {
      key: 'gender',
    ...
    },
    {
      ...
      type: 'date',
      helpText:
        'Leave blank if born on this farm and unknown, or imported/unknown.',
      section: 'Identification',
    },
    {
      key: 'serial_number',
      label: 'Serial Number',
      type: 'text',
      helpText: 'Asset tag from item_lot_serials, distinct from RFID/ear tag.',
      section: 'Identification',
    },
    {
      key: 'rfid_tag',
      label: 'RFID Tag',
      type: 'text',
      helpText: 'Unique if set.',
      section: 'Identification',
    },
    {
      key: 'ear_tag',
      label: 'Ear Tag (Visual)',
      type: 'text',
      section: 'Identification',
    },
    {
      key: 'ear_tag_image_url',
      label: 'Ear Tag Image URL',
      type: 'text',
      placeholder: 'https://cdn.navfarm.io/ear-tags/...',
      helpText:
        'Paste an image URL for now; direct file upload to Cloudflare R2 is planned for later.',
      section: 'Identification',
    },
    {
      key: 'sire_animal_id',
      ...
      type: 'select-entity',
      searchable: true,
      entityEndpoint: '/animal',
      entityValueKey: 'animal_id',
      entityLabelKeys: ['animal_code'],
      section: 'Lineage',
    },
    {
      key: 'dam_animal_id',
    ...
    {
      key: 'age_at_entry_weeks',
      label: 'Age at Entry (Weeks)',
      type: 'number',
      readOnly: true,
      helpText: 'Computed from Date of Birth and Entry Date.',
      section: 'Acquisition',
    },
    ...
    {
      key: 'source_receipt_id',
      label: 'Source Goods Receipt',
      type: 'select-entity',
      searchable: true,
      entityEndpoint: '/goods-receipt',
      entityValueKey: 'receipt_id',
      entityLabelKeys: ['receipt_no'],
      visibleWhen: {
        anyOf: [
          {
            key: 'entry_type',
            equals: ['PURCHASED_IMPORTED', 'PURCHASED_LOCAL'],
          },
        ],
      },
      requiredWhen: {
      ...
      helpText: 'The receipt this animal arrived on.',
      section: 'Acquisition',
    },
    {
      key: 'source_batch_id',
      ...
      type: 'select-entity',
      searchable: true,
      entityEndpoint: '/batch',
      entityValueKey: 'batch_id',
      entityLabelKeys: ['batch_no'],
      visibleWhen: { anyOf: [{ key: 'entry_type', equals: 'BORN_ON_FARM' }] },
      requiredWhen: { anyOf: [{ key: 'entry_type', equals: 'BORN_ON_FARM' }] },
      helpText: 'The farrowing batch this animal was born from.',
      section: 'Acquisition',
    },
    ...
    {
      key: 'item_id',
      label: 'Item (Living Asset)',
      type: 'select-entity',
      required: true,
      searchable: true,
      entityEndpoint: '/item?itemType=LIVESTOCK',
      entityValueKey: 'item_id',
      entityLabelKeys: ['item_code', 'item_name'],
      section: 'Acquisition',
    },
    ...
    // has no document behind it and is entered by hand.
    {
      ...
      helpText: 'Taken from the rate on the source goods receipt.',
      section: 'Acquisition',
    },
    {
      key: 'acquisition_cost',
    ...
    },
    {
      ...
      step: '0.01',
      helpText:
        'Transport/import duty/quarantine charges for imported animals.',
      section: 'Acquisition',
    },
    ...
    {
      key: 'total_opening_asset_value',
      label: 'Total Opening Asset Value',
      type: 'number',
      step: '0.01',
      readOnly: true,
      helpText: 'Acquisition Cost + Landing Cost. Calculated on save.',
      section: 'Acquisition',
    },
    ...
    {
      key: 'current_bio_asset_value',
      label: 'Current Bio-Asset Value',
      type: 'number',
      step: '0.01',
      editOnly: true,
      helpText:
        'Set from acquisition cost at creation; adjust here afterward. Reconciles with D365BC: each animal is a Child Fixed Asset there, and BC posts acquisition and returns the FA Ledger Entry reference (Bio Asset BBP). No BC connector yet \u2014 this is a local figure.',
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    },
    {
      key: 'book_value',
      ...
      editOnly: true,
      helpText:
        'Reconciles with D365BC: each animal is a Child Fixed Asset there, and BC posts acquisition and returns the FA Ledger Entry reference (Bio Asset BBP). No BC connector yet \u2014 this is a local figure.',
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    },
    {
      key: 'total_amortised',
      label: 'Total Amortised',
      type: 'number',
      step: '0.01',
      editOnly: true,
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
    ...
    {
      key: 'expected_cull_date',
      label: 'Expected Cull Date',
      type: 'date',
      editOnly: true,
      helpText:
        "Derived from the productive life start and the breed's productive life.",
      section: 'Production',
    },
    {
      key: 'disposal_date',
      ...
      type: 'date',
      hideInForm: true,
      helpText: 'Set via the Dispose action, not direct edit.',
      section: 'Bio-Asset',
    },
    {
      key: 'disposal_type',
    ...
    },
    {
      ...
      type: 'number',
      helpText:
        'BBP §6: below 15 blocks this gilt from selection regardless of TSI score.',
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    },
    {
      ...
      type: 'number',
      step: '0.01',
      helpText: 'Total Sow Index score.',
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    },
    {
    ...
    },
    {
      ...
      helpText:
        'Sold, slaughtered, died or culled are recorded through Dispose, not here.',
    },
    ...
    // A sow transferred in with a parity history gets it on the first edit.
    {
      ...
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      helpText:
        'Completed pregnancies, incremented on weaning. Rolled up from farrowing records, so a manual figure is replaced at the next weaning.',
      section: 'Bio-Asset',
    },
    {
      key: 'total_piglets_born_live',
      label: 'Total Piglets Born Live',
      type: 'number',
      editOnly: true,
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    ...
    {
      key: 'total_piglets_weaned',
      label: 'Total Piglets Weaned',
      type: 'number',
      editOnly: true,
      visibleWhen: { anyOf: [{ key: 'gender', equals: 'F' }] },
      section: 'Bio-Asset',
    ...
    {
      key: 'productive_life_start',
      label: 'Productive Life Start',
      type: 'date',
      section: 'Production',
    },
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this category is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this category is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'category_code',
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Animal Feed Products',
    },
    {
      key: 'item_type',
      label: 'Item Type',
      ...
      entityLabelKeys: ['type_code', 'type_name'],
      helpText:
        "Assigns this category to an Item Type so it shows up in the Item form's Category picker once that type is chosen. Leave blank for a category not yet classified.",
    },
    {
...
const itemType: MasterDataConfig = {
  ...
  label: 'Item Types',
  description:
    'Item type classification (RAW_MATERIAL, CONSUMABLE, MEDICINE, ...) used by the Items master.',
  apiBase: '/item-type',
  idKey: 'item_type_id',
  group: 'Inventory',
  lookupFor: ['item'],
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this item type is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this item type is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this unit is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this unit is shared across all LOBs under the selected NOB.',
    },
    {
      key: 'company_id',
      label: 'Company (blank = global)',
      type: 'text',
      hideInForm: true,
    },
    {
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['WEIGHT', 'VOLUME', 'COUNT', 'AREA', 'TIME', 'OTHER'].map(
        (v) => ({ value: v, label: v }),
      ),
    },
...
const uomConversion: MasterDataConfig = {
  ...
  description:
    'Multiplier factors between units — From × Factor = To. Used to price data entry.',
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this conversion is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this conversion is shared across all LOBs under the selected NOB.',
    },
    {
      key: 'company_id',
      label: 'Company (blank = global)',
    ...
    // (Unit Of Measure.xlsx). Their wording is the sheet's own, not a paraphrase.
    {
      ...
      entityLabelKeys: ['item_code', 'item_name'],
      helpText:
        'Leave blank for a factor that applies to every item using these units.',
    },
    ...
    },
    {
      ...
      placeholder: '50',
      helpText:
        'Multiply the From quantity to get the base quantity. 1 BAG = 50 KG, so the factor is 50.',
    },
    ...
    // Flagged in docs/masters-evidence; needs a client answer, not a guess.
    {
      ...
      required: true,
      helpText:
        'Not on the client template — our column. Use the date this factor starts applying.',
    },
    {
      key: 'effective_to',
      label: 'Effective To',
      type: 'date',
      helpText: 'Leave blank while the factor is open-ended.',
    },
  ],
};
...
const itemAttribute: MasterDataConfig = {
  ...
  description:
    'Custom item attributes (e.g. Protein %, Colour) available to select when editing an item.',
  ...
  fields: [
    ...
    },
    {
      ...
      entityValueKey: 'nob_id',
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText: 'Leave blank to make this attribute available across all NOBs.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank to make this attribute available across all LOBs under the selected NOB.',
    },
    {
      key: 'attribute_code',
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['TEXT', 'NUMBER', 'DATE', 'BOOLEAN'].map((v) => ({
        value: v,
        label: v,
      })),
    },
    ...
    {
      key: 'is_mandatory',
      label: 'Mandatory on every item in scope',
      type: 'boolean',
    },
    { key: 'affects_costing', label: 'Affects Costing', type: 'boolean' },
    {
      key: 'is_variant',
      label: 'Distinguishes Item Variants',
      type: 'boolean',
    },
  ],
};
...
const item: MasterDataConfig = {
  ...
  owner: 'BC',
  bcNote:
    'BBP-1 §1.5: \u201CItems (feed, medicine, vaccine, semen dose, overhead supplies) are CREATED IN D365BC only. NAVFarm cannot create items independently.\u201D',
  bcFields: [
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this item is used across all business verticals.',
    ...
    },
    {
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this item is used across all LOBs under the selected NOB.',
      section: 'Classification',
    },
    {
      key: 'item_code',
      ...
      readOnly: true,
      helpText:
        'Assigned from the Item number series unless manual entry is selected.',
      section: 'Identification',
    },
    {
      key: 'item_name',
      ...
      type: 'text',
      required: true,
      placeholder: 'Sow lactation feed',
      section: 'Identification',
    },
    {
      key: 'item_type',
    ...
    },
    {
      ...
      dependsOnMode: 'query',
      queryParams: { category_id: 'parentCategoryId' },
      requiresParent: true,
      section: 'Identification',
      helpText:
        "Optional. Lists categories whose parent is the selected Category above — create one there first if the subcategory you need doesn't exist yet.",
    },
    ...
    },
    {
      ...
      key: 'uom_conversion_factor',
      label: 'UOM Conversion Factor',
      type: 'number',
      step: '0.000001',
      section: 'Units & Valuation',
      derivedFrom: {
        endpoint: '/uom/conversion',
        params: { uom_primary: 'fromUom', uom_secondary: 'toUom' },
        valueKey: 'conversion_factor',
        missingHelpText:
          'No conversion exists for these units yet — enter it once and it is saved to UOM Conversion.',
      },
      helpText:
        'Choose a Primary and Secondary UOM; the factor comes from UOM Conversion.',
    },
    {
      key: 'valuation_method',
      label: 'Valuation Method',
      type: 'select-entity',
      entityEndpoint: '/costing-method',
      entityValueKey: 'method_code',
      entityLabelKeys: ['method_code', 'method_name'],
      helpText: 'Leave blank to inherit the LOB default.',
      section: 'Units & Valuation',
    },
    ...
    // other method the cost is not merely optional, it has no meaning.
    {
      ...
      step: '0.01',
      section: 'Units & Valuation',
      visibleWhen: { anyOf: [{ key: 'valuation_method', equals: 'STANDARD' }] },
      requiredWhen: {
        anyOf: [{ key: 'valuation_method', equals: 'STANDARD' }],
      },
      helpText: 'Per Primary UOM. Required when Valuation Method is STANDARD.',
    },
    ...
    // entirely. All three now stand together, in the order they are decided.
    {
      ...
      type: 'boolean',
      filterOnly: true,
      seedFromAnyTrue: ['is_lot_tracked', 'is_serial_tracked'],
      helpText:
        'Track individual lots or serial numbers of this item through the chain.',
      section: 'Tracking',
    },
    {
      key: 'tracking_type',
    ...
    // pair of flags where the form asked one question.
    {
      ...
      readOnly: true,
      hideInTable: true,
      visibleWhen: { anyOf: [{ key: 'is_lot_tracked', equals: true }] },
      section: 'Tracking',
    },
    {
      ...
      readOnly: true,
      hideInTable: true,
      visibleWhen: { anyOf: [{ key: 'is_serial_tracked', equals: true }] },
      section: 'Tracking',
    },
    { key: 'is_biological_asset', label: 'Biological Asset', type: 'boolean' },
    {
      ...
      type: 'boolean',
      helpText:
        'Held as stock, with a balance and a valuation. Off for services and consumables that are expensed on receipt.',
      section: 'Inventory',
    },
    {
      key: 'min_stock_level',
    ...
    },
    {
      ...
      type: 'number',
      visibleWhen: WHEN_INVENTORIED,
      helpText: 'Procurement lead time, for feed/stock forecast planning.',
      section: 'Inventory',
    },
    {
      key: 'shelf_life_days',
    ...
    },
    {
      ...
      visibleWhen: {
        anyOf: [
          { key: 'is_inventoriable', equals: true },
          { key: 'item_type', equals: ['MEDICINE', 'VACCINE'] },
        ],
      },
      requiredWhen: {
        anyOf: [{ key: 'item_type', equals: ['MEDICINE', 'VACCINE'] }],
      },
      helpText:
        'Up to 99 days. Required for MEDICINE/VACCINE items — minimum days after last administration before an animal treated with this item may be slaughtered.',
    },
    { key: 'is_qr_enabled', label: 'QR Tracking Enabled', type: 'boolean' },
    {
      ...
      type: 'text',
      placeholder: 'https://cdn.navfarm.io/items/...',
    },
    {
      ...
      entityValueKey: 'gl_account_id',
      entityLabelKeys: ['account_code', 'account_name'],
      helpText: 'GL account this item posts inventory value to.',
      section: 'Accounting',
    },
    {
      key: 'cogs_gl_account',
      ...
      entityValueKey: 'gl_account_id',
      entityLabelKeys: ['account_code', 'account_name'],
      helpText: 'GL account this item posts cost of goods sold to.',
      section: 'Accounting',
    },
    {
      key: 'is_blocked',
      ...
      type: 'boolean',
      helpText:
        'A blocked item stays visible/historical but cannot be transacted.',
      section: 'Accounting',
    },
    {
      ...
      jsonRow: [
        {
          ...
          label: 'Attribute',
          type: 'select-entity',
          entityEndpoint: '/item-attribute',
          entityValueKey: 'attribute_id',
          entityLabelKeys: ['attribute_code', 'attribute_name'],
        },
        {
          key: 'attribute_value',
          label: 'Value',
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this species is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this species is shared across all LOBs under the selected NOB.',
    },
    {
      key: 'company_id',
      label: 'Company (blank = global)',
  ...
  fields: [
    {
      ...
      type: 'select-entity',
      entityEndpoint: '/location?locationType=FARM&rootOnly=true',
      entityValueKey: 'location_id',
      entityLabelKeys: ['location_code', 'location_name'],
      section: 'Identification',
      helpText:
        'Only active, first-level farms without a parent. When selected, the farm code prefixes the generated breed code.',
    },
    {
      key: 'company_id',
      label: 'Company (blank = global)',
    ...
    },
    {
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this breed applies to all LOBs under the selected NOB.',
      section: 'Identification',
    },
    {
      key: 'breed_code',
    ...
    },
    {
      ...
      entityValueKey: 'species_id',
      entityLabelKeys: ['species_code', 'species_name'],
      section: 'Identification',
    },
    {
      key: 'breed_type',
      ...
      options: ['MEAT', 'BREEDER', 'DUAL_PURPOSE'].map((v) => ({
        value: v,
        label: v.replace(/_/g, ' '),
      })),
    },
    ...
    {
      key: 'avg_growth_rate_g_day',
      label: 'Avg Growth Rate (g/day)',
      type: 'number',
      step: '0.01',
    ...
    },
    {
      ...
      type: 'number',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'lactation_days',
    ...
    {
      key: 'avg_litter_size_born',
      label: 'Avg Litter Size Born',
      type: 'number',
      step: '0.01',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'avg_litter_size_weaned',
      label: 'Avg Litter Size Weaned',
      type: 'number',
      step: '0.01',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'avg_weaning_weight_kg',
      label: 'Avg Weaning Weight (KG)',
      type: 'number',
      step: '0.001',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'farrowing_rate_pct',
    ...
    {
      key: 'productive_life_months',
      label: 'Productive Life (months)',
      type: 'number',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'productive_life_cycles',
      label: 'Productive Life Cycles',
      type: 'number',
      helpText:
        'Expected number of parities in productive life. A parity count only applies to a female.',
      section: 'Reproduction — Female (Sow)',
    },
    {
      key: 'boar_doses_per_week',
      label: 'Doses per Week',
      type: 'number',
      step: '0.01',
      helpText: 'Semen doses collected per week — a male KPI.',
      section: 'Reproduction — Male (Boar)',
    },
    {
      key: 'boar_productive_life_months',
      label: 'Productive Life (months)',
      type: 'number',
      helpText:
        'How long a boar stays productive — amortisation input for a male.',
      section: 'Reproduction — Male (Boar)',
    },
    {
      key: 'mature_age_months',
      label: 'Mature Age (months)',
      type: 'number',
      section: 'Productive Life',
    },
    {
      ...
      step: '0.01',
      helpText:
        'Salvage value as percent of opening asset value — amortisation input.',
      section: 'Productive Life',
    },
    {
      key: 'age_labels',
      label: 'Stage Age Labels',
      type: 'json',
      section: 'Productive Life',
      helpText:
        'Stage labels by week range (JSON), shown on the data entry screen header.',
    },
    {
      key: 'is_blocked',
      label: 'Blocked',
      type: 'boolean',
      helpText:
        'A blocked breed stays visible/historical but cannot be used on new animals.',
      section: 'Productive Life',
    },
  ],
};
...
const breedLifecycleStage: MasterDataConfig = {
  ...
  description:
    'Per-breed, per-stage production standards — feed rate, ADG, FCR, mortality, expected output — for a period range within that stage.',
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this lifecycle row is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this lifecycle row is shared across all LOBs under the selected NOB.',
    },
    {
      key: 'lifecycle_code',
      ...
      placeholder: 'BLS-001',
      helpText:
        'Optional. Leave blank until the numbering convention is agreed; a series can generate it later.',
    },
    {
      key: 'breed_id',
      label: 'Breed',
    ...
    },
    {
      ...
      type: 'select',
      helpText:
        'The class of animal this standard is written for — the same list the Animal Register uses.',
      options: ['SOW', 'GILT', 'BOAR', 'PIGLET', 'COMMERCIAL_PIG'].map((v) => ({
        value: v,
        label: v.replace(/_/g, ' '),
      })),
    },
    ...
    {
      key: 'std_teats',
      label: 'Standard Teat Count',
      type: 'number',
      helpText:
        'Minimum teat count expected at this stage. BBP §6 blocks gilt selection below 15.',
    },
    {
      key: 'season_type',
      label: 'Season',
    ...
    {
      key: 'feed_qty_per_head_per_day_kg',
      label: 'Feed Qty per Head per Day (KG)',
      type: 'number',
      step: '0.0001',
    },
    {
      key: 'feed_wastage_pct',
      label: 'Feed Wastage %',
      type: 'number',
      step: '0.01',
    },
    {
      key: 'std_body_weight_kg',
      label: 'Std Body Weight (KG)',
      type: 'number',
      step: '0.001',
    },
    {
    ...
    {
      key: 'std_mortality_rate_pct',
      label: 'Std Mortality Rate %',
      type: 'number',
      step: '0.001',
    },
    {
    ...
    },
    {
      ...
      type: 'json',
      helpText:
        'One entry per KPI, each with its own alert: [{ metric, lower_limit, upper_limit, severity }]. Severity is INFO, WARNING or CRITICAL.',
    },
    ...
    // column existed and nothing on the form could fill it.
    {
      ...
      type: 'json',
      helpText:
        'Resources this breed needs at this stage, from the resource planner.',
    },
    ...
    {
      key: 'vaccination_protocol',
      label: 'Vaccination Protocol',
      type: 'json',
      jsonRow: [
        {
          key: 'vaccine_item_id',
          label: 'Vaccine',
          type: 'select-entity',
          entityEndpoint: '/item?itemType=VACCINE',
          entityValueKey: 'item_id',
          entityLabelKeys: ['item_code', 'item_name'],
        },
        {
      ...
      helpText:
        "One row per vaccination. Triggered by tells the scheduler what to count from — the animal's age, weeks pregnant, or every pregnancy cycle.",
    },
    {
      key: 'medication_protocol',
      ...
      jsonRow: [
        ...
        },
        {
          ...
          label: 'Symptom',
          type: 'text',
          placeholder: 'Scour — 1st line',
        },
        {
          key: 'medicine_item_id',
          label: 'Drug',
          type: 'select-entity',
          entityEndpoint: '/item?itemType=MEDICINE',
          entityValueKey: 'item_id',
          entityLabelKeys: ['item_code', 'item_name'],
        },
        { key: 'dose', label: 'Dose', type: 'text', placeholder: '0.5ml' },
        {
          ...
          label: 'Repeat',
          type: 'text',
          placeholder: 'every day for 3 days',
        },
        { key: 'withdrawal_days', label: 'Withdrawal (days)', type: 'number' },
      ],
      helpText:
        "One row per problem, as the farm's treatment card is written. Dose is free text because the card records it per head and per kg both.",
    },
    {
      key: 'notes',
      label: 'Notes',
      type: 'textarea',
      helpText: 'Shown as a tooltip on the data entry screen.',
    },
...
const reason: MasterDataConfig = {
  ...
  group: 'Livestock & Health',
  isPrimary: true,
  businessAdminOnly: true,
  description:
    'Shared company reasons for mortality, culling, returns, selection, disposal and transfers. Only documented examples are loaded; Tenant and Company Admins maintain this catalog.',
  columns: [
    { key: 'reason_code', label: 'Code' },
    { key: 'reason_name', label: 'Name' },
    { key: 'category', label: 'Category' },
    { key: 'mandatory_weight', label: 'Weight Required' },
  ],
  supportsNobLobFilter: true,
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this reason is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this reason is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'reason_code',
    ...
    },
    {
      ...
      multiple: true,
      entityEndpoint: '/stage',
      entityValueKey: 'stage_code',
      entityLabelKeys: ['stage_code', 'stage_name'],
      helpText:
        'Select the stages where this reason is available. Leave all unchecked for all stages.',
    },
    {
      key: 'mandatory_weight',
      label: 'Weight Required',
      type: 'boolean',
      helpText:
        'Reason requires a positive KG value when posting. Posting-screen integration is separate from this catalog.',
    },
  ],
};
...
const disease: MasterDataConfig = {
  ...
  label: 'Diseases',
  description:
    'Disease reference catalog with symptoms and treatment guidelines.',
  apiBase: '/disease',
  idKey: 'disease_id',
  group: 'Livestock & Health',
  lookupFor: ['breed'],
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this disease is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this disease is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'disease_code',
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Avian paramyxovirus 1',
    },
    { key: 'symptoms', label: 'Symptoms', type: 'textarea' },
    {
      key: 'treatment_guideline',
      label: 'Treatment Guideline',
      type: 'textarea',
    },
  ],
};
...
const feedFormula: MasterDataConfig = {
  ...
  label: 'Feed Formulas',
  description:
    'Feed recipes (BOM). Ingredients are edited as a JSON array — one entry per raw material.',
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Broiler Starter Feed Formula',
    },
    {
      key: 'nob_id',
      label: 'Nature of Business',
      ...
      filterOnly: true,
      helpText:
        "Scopes the Produced Item picker below — feed formulas aren't NOB/LOB-scoped themselves.",
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
    ...
    },
    {
      ...
      entityValueKey: 'item_id',
      entityLabelKeys: ['item_code', 'item_name'],
      dependsOn: ['nob_id', 'lob_id'],
      dependsOnMode: 'query',
      queryParams: { nob_id: 'nobId', lob_id: 'lobId' },
    },
    {
      key: 'batch_size',
      label: 'Batch Size',
    ...
    // which legitimately spans every type.
    {
      ...
      type: 'select-entity',
      required: true,
      entityEndpoint: '/uom?uomType=WEIGHT',
      entityValueKey: 'uom_code',
      entityLabelKeys: ['uom_code', 'uom_name'],
    },
    { key: 'description', label: 'Description', type: 'textarea' },
    {
      ...
      helpText:
        'Array of { item_id, quantity, unit, inclusion_pct?, loss_pct? }. Example: [{"item_id":"...","quantity":650,"unit":"KG"}]. Set at creation only — the API does not yet support editing ingredients after a formula is created.',
    },
  ],
};
...
const supplier: MasterDataConfig = {
  owner: 'BC',
  bcNote:
    'MOM 18 Aug 2026 (Triple C Office), procurement flow Req \u2192 Order \u2192 Vendor \u2192 GRV \u2192 PI: \u201CRequisition (Req) will be raised and maintained in NavFarm. Order, Vendor selection, GRV and PI will be processed in D365BC.\u201D BBP-1 \u00A71 also lists Vendor among the masters, without specifying it.',
  key: 'supplier',
  label: 'Suppliers',
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this supplier is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this supplier is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'supplier_code',
      ...
      type: 'text',
      readOnly: true,
      placeholder: 'Generated as SUP-001',
      helpText:
        "Generated automatically from this company's Supplier sequence.",
      section: 'Identification',
    },
    {
      key: 'supplier_name',
      ...
      type: 'text',
      required: true,
      placeholder: 'Feed Ingredients Corp Ltd',
      section: 'Identification',
    },
    {
      key: 'vendor_type',
    ...
    },
    {
      ...
      type: 'boolean',
      hideInForm: true,
      helpText: 'Use the Approve action, not direct edit.',
      section: 'Identification',
    },
    {
      key: 'email',
      label: 'Email',
      type: 'email',
      placeholder: 'orders@feedingredients.com',
      section: 'Contact',
    },
    ...
    },
    {
      ...
      type: 'text',
      helpText:
        'Stored encrypted. Enter a value here to replace it; leave blank to keep the existing one.',
      section: 'Banking',
    },
    {
      key: 'bank_ifsc',
    ...
    },
    {
      ...
      type: 'text',
      helpText:
        'Required for ANIMAL_SUPPLIER — checked before a Goods Receipt from this vendor can post.',
      section: 'Compliance',
    },
    {
      key: 'breeding_farm_code',
      label: 'Breeding Farm Registration No.',
      type: 'text',
      helpText: 'Required for ANIMAL_SUPPLIER / BREEDING_FARM.',
      section: 'Compliance',
    },
  ],
};
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this customer is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this customer is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'customer_code',
      ...
      type: 'text',
      readOnly: true,
      placeholder: 'Generated as CUS-001',
      helpText:
        "Generated automatically from this company's Customer sequence.",
      section: 'Identification',
    },
    {
      key: 'customer_name',
      ...
      type: 'text',
      required: true,
      placeholder: 'John Doe Wholesalers',
      section: 'Identification',
    },
    {
      key: 'email',
      label: 'Email',
      type: 'email',
      placeholder: 'billing@johndoe.com',
      section: 'Contact',
    },
    {
      key: 'mobile',
...
const resource: MasterDataConfig = {
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this resource is shared across all business verticals.',
      section: 'Identification',
    },
    {
      key: 'lob_id',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this resource is shared across all LOBs under the selected NOB.',
      section: 'Identification',
    },
    {
      key: 'resource_code',
      ...
      type: 'text',
      readOnly: true,
      placeholder: 'Generated as RES-001',
      helpText:
        "Generated automatically from this company's Resource sequence.",
      section: 'Identification',
    },
    {
      key: 'resource_name',
    ...
    },
    {
      ...
      options: ['MANPOWER', 'EQUIPMENT', 'VEHICLE', 'UTILITY', 'OTHER'].map(
        (v) => ({ value: v, label: v }),
      ),
    },
    {
      ...
      helpText:
        'PERMANENT/CONTRACT/DAILY for labor; OWNED/LEASED/RENTED for equipment or vehicles.',
    },
    {
      key: 'employee_id',
      label: 'Employee ID',
      type: 'text',
      placeholder: 'EMP-001',
      helpText: 'Labor/manpower only.',
      section: 'People',
      visibleWhen: {
        anyOf: [{ key: 'resource_type', equals: ['MANPOWER', 'LABOR'] }],
      },
    },
    {
      key: 'designation',
      label: 'Designation',
      type: 'text',
      placeholder: 'Senior Farm Worker',
      helpText: 'Labor/manpower only.',
      section: 'People',
      visibleWhen: {
        anyOf: [{ key: 'resource_type', equals: ['MANPOWER', 'LABOR'] }],
    ...
    },
    {
      ...
      label: 'Cost Element',
      type: 'text',
      placeholder: 'DIRECT_LABOR',
      helpText:
        'GL cost classification, e.g. DIRECT_LABOR / INDIRECT_LABOR / EQUIPMENT_HIRE / FUEL / MAINTENANCE.',
      section: 'Capacity & Cost',
    },
    {
      key: 'gl_cost_account',
      label: 'GL Cost Account',
      type: 'select-entity',
      searchable: true,
      entityEndpoint: '/gl-account',
      entityValueKey: 'gl_account_id',
      entityLabelKeys: ['account_code', 'account_name'],
      helpText: 'GL account this resource posts cost to.',
      section: 'Capacity & Cost',
    },
    {
      key: 'asset_code',
      label: 'Asset Code',
      type: 'text',
      placeholder: 'ASSET-PELLETISER-01',
      helpText: 'Equipment/vehicle only.',
      section: 'Asset',
      visibleWhen: {
        anyOf: [{ key: 'resource_type', equals: ['EQUIPMENT', 'VEHICLE'] }],
      },
    },
    {
      key: 'asset_make',
    ...
    {
      key: 'maintenance_frequency_days',
      label: 'Maintenance Frequency (days)',
      type: 'number',
      helpText:
        'Days between scheduled services. Logging a completed service auto-calculates the next due date.',
      section: 'Maintenance',
      visibleWhen: {
        anyOf: [{ key: 'resource_type', equals: ['EQUIPMENT', 'VEHICLE'] }],
      },
    ...
    {
      key: 'maintenance_cost_per_service',
      label: 'Est. Cost per Service',
      type: 'number',
      step: '0.01',
      section: 'Maintenance',
      visibleWhen: {
    ...
    },
    {
      ...
      label: 'Last Maintenance (system-tracked)',
      type: 'date',
      hideInForm: true,
      section: 'Maintenance',
    },
    {
      ...
      label: 'Next Maintenance (system-tracked)',
      type: 'date',
      hideInForm: true,
      section: 'Maintenance',
    },
    {
      ...
      type: 'date',
      helpText: 'License/certification expiry — alert 30 days before.',
      section: 'Maintenance',
      visibleWhen: {
        anyOf: [{ key: 'resource_type', equals: ['EQUIPMENT', 'VEHICLE'] }],
      },
...
const glAccount: MasterDataConfig = {
  ...
  owner: 'BC',
  bcNote:
    'BBP-1 §1.6: \u201CNAVFarm does NOT maintain its own Chart of Accounts. COA lives entirely in D365BC.\u201D',
  bcFields: [
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this G/L account is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this G/L account is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      key: 'account_code',
...
const glMapping: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      entityValueKey: 'nob_id',
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText: 'Leave blank to match all NOBs.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      entityLabelKeys: ['lob_code', 'lob_name'],
      dependsOn: 'nob_id',
      helpText: 'Leave blank to match all LOBs under the selected NOB.',
    },
    {
      key: 'stage_id',
      ...
      entityLabelKeys: ['stage_code', 'stage_name'],
      helpText:
        'Leave blank to match all stages (wildcard). Set to make this mapping win only when the batch/animal is in this specific stage.',
    },
    {
      key: 'valuation_method',
      label: 'Valuation Method',
      ...
      entityValueKey: 'method_code',
      entityLabelKeys: ['method_code', 'method_name'],
      helpText: 'Leave blank to match all costing methods.',
    },
    {
      ...
      options: [
        ...
        {
          value: 'TRANSFER_SHIPMENT',
          label: 'Transfer Out — Stock Transfer (Shipment)',
        },
        {
          value: 'TRANSFER_RECEIPT',
          label: 'Transfer In — Stock Transfer (Receipt)',
        },
        {
          value: 'VARIANCE_POSITIVE',
          label: 'Stock Adjustment — Positive Variance',
        },
        {
          value: 'VARIANCE_NEGATIVE',
          label: 'Stock Adjustment — Negative Variance',
        },
        ...
        {
          value: 'BATCH_IMPAIRMENT',
          label: 'Batch — By-Product / Waste Impairment (at-cost vs NRV)',
        },
        { value: 'MORTALITY', label: 'Batch — Mortality Write-off' },
        { value: 'OVERHEAD', label: 'Batch — Overhead' },
        {
          value: 'PRICE_VARIANCE',
          label: 'Batch — Price Variance (Standard Costing)',
        },
        {
          value: 'USAGE_VARIANCE',
          label: 'Batch — Usage Variance (Standard Costing)',
        },
        {
          value: 'OUTPUT_VARIANCE',
          label: 'Batch — Output Variance (Standard Costing)',
        },
        {
          value: 'OVERHEAD_VARIANCE',
          label: 'Batch — Overhead Variance (Standard Costing)',
        },
        // Batch — Bio-Asset (IAS 41) costing lifecycle
        { value: 'BIO_ACQUISITION', label: 'Bio-Asset — Acquisition' },
        {
          value: 'BIO_CONSUMPTION_PREMATURE',
          label: 'Bio-Asset — Consumption (Pre-mature, Capitalized)',
        },
        {
          value: 'BIO_CONSUMPTION_MATURE',
          label: 'Bio-Asset — Consumption (Mature, Expensed)',
        },
        { value: 'BIO_OUTPUT', label: 'Bio-Asset — Output' },
        {
          value: 'BIO_MORTALITY_PREMATURE',
          label: 'Bio-Asset — Mortality (Pre-mature)',
        },
        {
          value: 'BIO_MORTALITY_MATURE',
          label: 'Bio-Asset — Mortality (Mature)',
        },
        {
          value: 'BIO_OVERHEAD_PREMATURE',
          label: 'Bio-Asset — Overhead (Pre-mature)',
        },
        {
          value: 'BIO_OVERHEAD_MATURE',
          label: 'Bio-Asset — Overhead (Mature)',
        },
        {
          value: 'BIO_TRANSFORMATION',
          label: 'Bio-Asset — Transformation (Pre-mature → Mature)',
        },
...
const costCenter: MasterDataConfig = {
  owner: 'BC',
  bcNote:
    'BBP-1 §1.8: \u201CDimensions are configured in D365BC and mirrored in NAVFarm dimension master via API sync. The dimensions (cost centre) will be created in NAVFarm same as in BC365.\u201D The primary mandatory dimension is Cost Centre = Farm Code.',
  key: 'cost-center',
  label: 'Cost Centers',
  ...
  fields: [
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this cost centre is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this cost centre is shared across all LOBs under the selected NOB.',
    },
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['DEPARTMENT', 'FARM', 'WAREHOUSE', 'PROJECT', 'OTHER'].map(
        (v) => ({ value: v, label: v }),
      ),
    },
    {
      ...
      type: 'select-entity',
      entityEndpoint: '/cost-center',
      entityValueKey: 'cost_center_id',
...
const country: MasterDataConfig = {
  ...
  singular: 'Country',
  description:
    'Countries the business deals with — used by currencies, suppliers and customers.',
  apiBase: '/country',
  idKey: 'country_id',
  group: 'Finance',
  ...
  fields: [
    {
      ...
      placeholder: 'ZW',
      helpText:
        'The two-letter ISO 3166-1 alpha-2 code. This is what currencies and addresses store.',
    },
    {
      key: 'country_name',
      label: 'Country Name',
    ...
    },
    {
      ...
      required: true,
      placeholder: 'ZWE',
      helpText: 'The three-letter ISO 3166-1 alpha-3 code.',
    },
    {
      key: 'phone_code',
      label: 'Dialing Code',
...
const currency: MasterDataConfig = {
  ...
  singular: 'Currency',
  description:
    'Currencies the business transacts in, and the countries each one is legal tender in.',
  apiBase: '/currency',
  idKey: 'currency_id',
  group: 'Finance',
  isPrimary: true,
  ...
  fields: [
    {
      ...
      required: true,
      placeholder: 'USD',
      helpText: 'The three-letter ISO 4217 code. Saved uppercase, and unique.',
    },
    {
      key: 'currency_name',
      label: 'Currency Name',
    ...
    },
    {
      ...
      type: 'select-entity',
      multiple: true,
      entityEndpoint: '/country',
      entityValueKey: 'iso2',
      entityLabelKeys: ['iso2', 'country_name'],
    ...
    },
    {
      ...
      placeholder: '2',
      helpText:
        '0 for currencies with no minor unit, such as the yen and the dong.',
    },
  ],
};
...
const exchangeRate: MasterDataConfig = {
  ...
  description:
    'Manually entered USD conversion rates. Each row reads 1 USD = rate, on a date.',
  ...
  fields: [
    {
      ...
      type: 'select-entity',
      required: true,
      entityEndpoint: '/currency',
      entityValueKey: 'currency_id',
      entityLabelKeys: ['iso_code', 'currency_name'],
    ...
    },
    {
      ...
      placeholder: '36.25',
      helpText:
        'How many units of the chosen currency one US dollar buys. 1 USD = 36.25 ZWL is entered as 36.25.',
    },
    {
      key: 'rate_date',
      label: 'Rate Date',
      ...
      required: true,
      helpText:
        'Rates are kept per date and never overwritten, so a past period can be restated at the rate that applied then.',
    },
    {
      key: 'rate_source',
      label: 'Source',
      type: 'text',
      placeholder: 'MANUAL',
      helpText: 'Where the rate came from. The client enters these by hand.',
    },
  ],
};
