...
const DEFAULT_RESOURCES = [
  // AUDIT
  {
    module_code: 'AUDIT',
    resource: 'LOGS',
    name: 'Audit Logs & Trails',
    nameKey: 'rolAuditLogsTrails',
  },
  // COMPANY
  {
    module_code: 'COMPANY',
  ...
  // FINANCE (Phase 4)
  {
    ...
    nameKey: 'jpJournalEntries',
  },
  {
    module_code: 'FINANCE',
    resource: 'REPORTS',
    name: 'Financial Reports',
    nameKey: 'rolFinancialReports',
  },
  // INVENTORY (Phase 3)
  {
  ...
  },
  {
    ...
    name: 'Goods Issue',
    nameKey: 'invGoodsIssue',
  },
  {
    module_code: 'INVENTORY',
    resource: 'STOCK_TRANSFER',
    name: 'Stock Transfer',
    nameKey: 'apDocType_STOCK_TRANSFER',
  },
  {
    module_code: 'INVENTORY',
    resource: 'STOCK_ADJUSTMENT',
    name: 'Stock Adjustment',
    nameKey: 'invStockAdjustment',
  },
  {
    module_code: 'INVENTORY',
    resource: 'LEDGER',
  ...
  },
  {
    ...
    resource: 'LOCATION',
    name: 'Locations',
    nameKey: 'rolLocations',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'ITEM_CATEGORY',
    name: 'Item Categories',
    nameKey: 'rolItemCategories',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'ITEM_TYPE',
    name: 'Item Types',
    nameKey: 'rolItemTypes',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'ITEM',
  ...
  },
  {
    ...
    resource: 'CUSTOMER',
    name: 'Customers',
    nameKey: 'rolCustomers',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'RESOURCE',
    name: 'Resources (Labor/Equipment)',
    nameKey: 'rolResourcesLabor',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'DISEASE',
  ...
  },
  {
    ...
    name: 'Feed Formulas',
    nameKey: 'rolFeedFormulas',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'GL_ACCOUNT',
    name: 'GL Accounts',
    nameKey: 'rolGlAccounts',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'GL_MAPPING',
    name: 'GL Mappings',
    nameKey: 'rolGlMappings',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'COST_CENTER',
    name: 'Cost Centers',
    nameKey: 'rolCostCenters',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'CURRENCY',
    name: 'Currencies',
    nameKey: 'rolCurrencies',
  },
  // NOTIFICATION
  {
    ...
    nameKey: 'rolNotificationGateway',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'OPERATIONAL_AREA',
    name: 'Operational Areas',
    nameKey: 'operationalAreas',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'BREED_LIFECYCLE_STAGE',
    name: 'Breed Lifecycle Standards',
    nameKey: 'rolBreedLifecycleStandards',
  },
  {
    module_code: 'MASTER_DATA',
    resource: 'ACTIVITY',
    name: 'Activities',
    nameKey: 'rolActivities',
  },
  // PRODUCTION (Phase 5)
  {
  ...
  // PRODUCTION (Phase 6)
  {
    ...
    nameKey: 'rolProductionParameters',
  },
  {
    module_code: 'PRODUCTION',
    resource: 'BATCH_SCHEDULE',
    name: 'Production Schedulers',
    nameKey: 'rolProductionSchedulers',
  },
  // PRODUCTION (QC/QR)
  {
    module_code: 'PRODUCTION',
    ...
    name: 'QC Parameters',
    nameKey: 'navQcParameters',
  },
  {
    module_code: 'PRODUCTION',
    resource: 'QC',
    name: 'QC Inspections',
    nameKey: 'rolQcInspections',
  },
  {
    module_code: 'PRODUCTION',
    resource: 'QR_CODE',
    name: 'Traceability Packs (QR)',
    nameKey: 'rolTraceabilityPacks',
  },
  {
    module_code: 'PRODUCTION',
    resource: 'STAGE',
  ...
  // RBAC
  {
    ...
    nameKey: 'rolUserRolesTeam',
  },
  {
    module_code: 'RBAC',
    resource: 'USER',
    name: 'User Accounts',
    nameKey: 'rolUserAccounts',
  },
];
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start relative animate-fade-in">
      ...
      <div className="md:col-span-4 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          {visibleRoles.length === 0 ? (
            <div
              className="p-8 text-center text-xs border border-dashed rounded-[var(--radius-sm)]"
              ...
              return (
                <div
                  ...
                  className={`p-4 transition-all border rounded-[var(--radius-sm)] relative overflow-hidden flex flex-col gap-3 cursor-pointer ${
                    isCurrent ? 'shadow-sm' : 'hover:border-[var(--accent)]'
                  }`}
                  style={{
                ...
                >
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span
                        className="text-[9px] font-semibold px-1.5 py-0.5 rounded-[var(--radius-xs)] font-mono"
                        style={{
                    ...
                    <p
                      ...
                      style={S.textMuted}
                    >
                      {r.role_description || t('roleCustomOperatorScopes')}
                    </p>
                  </div>
                  <div
      ...
      <div className="md:col-span-8">
        {selectedRole ? (
          <Card className="p-6 flex flex-col gap-6" style={S.surface}>
            ...
            >
              <div>
                ...
                <p className="text-[9px] mt-1 font-mono" style={S.textMuted}>
                  {t('roleIdLabel', { id: selectedRole.role_id })}
                </p>
              </div>
              {selectedRole.is_system_role ? (
                <span
                  className="flex items-center gap-1.5 self-start py-2 px-3 text-[11px] font-semibold rounded-[var(--radius-sm)]"
                  style={{
                  ...
                  <TableHeader className="bg-transparent">
                    ...
                    >
                      ...
                      {[
                        ...
                        <TableHead
                          key={label}
                          className="h-auto px-0 pb-3 text-center w-20"
                        >
                          {t(k as any)}
                        </TableHead>
                      ))}
                      ...
                      <TableRow key={idx} style={S.textPrimary}>
                        ...
                        <TableCell className="px-0 py-3.5 font-semibold">
                          <div style={S.textPrimary}>
                            {p.nameKey
                              ? t(p.nameKey as TranslationKeys)
                              : p.name}
                          </div>
                          <div
          ...
          <div
            className="text-center p-16 rounded-[var(--radius-sm)] border border-dashed flex flex-col items-center justify-center"
            style={{ ...S.surface, ...S.textMuted }}
          >
            <ShieldAlert
      ...
      <Dialog
        ...
        footer={
          <>
            ...
            >
              {creatingRole ? t('saving') : t('create')}
            </Button>
          </>
        }
      >
        ...
        >
          <Field
            label={t('roleFieldRoleCode')}
            htmlFor="create-role-code"
            required
          >
            <Input
              id="create-role-code"
              placeholder={t('rolePhRoleCode')}
          ...
          <Field
            label={t('roleFieldRoleName')}
            htmlFor="create-role-name"
            required
          >
            <Input
              id="create-role-name"
              placeholder={t('rolePhRoleName')}
          ...
          <Field
            label={t('roleFieldDescription')}
            htmlFor="create-role-description"
          >
            <Input
              id="create-role-description"
              placeholder={t('rolePhDescription')}
      ...
      <Dialog
        ...
        description={
          editingRole
            ? t('roleModalEditDesc', { code: editingRole.role_code })
            : undefined
        }
        maxWidth="sm"
        footer={
      ...
      >
        {editingRole && (
          <form
            ...
            className="flex flex-col gap-4 pt-1"
          >
            <div className="text-[10px] font-mono" style={S.textMuted}>
              {t('roleCodeLabel', { code: editingRole.role_code })}
            </div>
            <Field
              label={t('roleFieldRoleName')}
            ...
            >
              <Input
                ...
                placeholder={t('rolePhDescriptionEdit')}
                value={editDesc}
