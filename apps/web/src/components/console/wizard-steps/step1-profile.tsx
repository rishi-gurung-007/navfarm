  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="p-4 rounded-[var(--radius-sm)] border border-(--border) bg-(--surface-raised) flex flex-col sm:flex-row items-center gap-4">
        <div className="w-20 h-20 rounded-[var(--radius-sm)] border border-dashed border-(--border) bg-(--input-bg) flex items-center justify-center overflow-hidden relative group shrink-0">
          {logoUrl ? (
            <img
              src={
                logoUrl.startsWith('/') ? `${backendUrl}${logoUrl}` : logoUrl
              }
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Field
          label={t('wzCompanyCodeShort')}
          htmlFor={fieldId('company_code')}
          required
        >
          <Input
        ...
        <Field
          label={t('wzDisplayName')}
          htmlFor={fieldId('company_display_name')}
        >
          <Input
        ...
        <Field
          label={t('wzRegCertificateNo')}
          htmlFor={fieldId('registration_no')}
        >
          <Input
        ...
        <Field
          ...
          htmlFor={fieldId('incorporation_date')}
        >
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, incorporation_date: e.target.value })
            }
          />
        </Field>
