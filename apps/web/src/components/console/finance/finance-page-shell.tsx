...
} from '@/components/shell/ContextNav';
...
const FINANCE_SECTIONS = [
  { key: 'journal', href: '/finance/journal', labelKey: 'finJournal' },
  {
    ...
    labelKey: 'finProfitLoss',
  },
  {
    key: 'balance-sheet',
    href: '/finance/balance-sheet',
    labelKey: 'finBalanceSheet',
  },
  {
    key: 'trial-balance',
    href: '/finance/trial-balance',
    labelKey: 'finTrialBalance',
  },
  {
    key: 'bio-asset-reconciliation',
    href: '/finance/bio-asset-reconciliation',
    labelKey: 'finBioAssetReconciliation',
  },
  {
    key: 'batch-cost-variance',
    href: '/finance/batch-cost-variance',
    labelKey: 'finBatchCostVariance',
  },
] as const;
...
function useFinancePageState() {
  ...
  const mayView = Boolean(
    ...
    (user.userType === 'OPERATIONAL_ADMIN' ||
      ...
      hasPermission(user, 'FINANCE', 'JOURNAL', 'can_view')),
  );
  ...
  const title =
    activeKey === 'journal'
      ...
      : activeKey === 'profit-loss'
        ? t('finProfitLossTitle')
        : activeKey === 'balance-sheet'
          ? t('finBalanceSheetTitle')
          : activeKey === 'trial-balance'
            ? t('finTrialBalanceTitle')
            : activeKey === 'batch-cost-variance'
              ? t('finBatchCostVarianceTitle')
